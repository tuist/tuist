# -*- encoding: utf-8 -*-
# stub: rubocop-shopify 2.4.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "allowed_push_host" => "https://rubygems.org", "source_code_uri" => "https://github.com/Shopify/ruby-style-guide/tree/v2.4.0" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.24"])
  end
end
