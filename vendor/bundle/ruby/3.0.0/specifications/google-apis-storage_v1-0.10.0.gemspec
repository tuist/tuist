# -*- encoding: utf-8 -*-
# stub: google-apis-storage_v1 0.10.0 ruby lib

Gem::Specification.new do |s|
  s.name = "google-apis-storage_v1".freeze
  s.version = "0.10.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/googleapis/google-api-ruby-client/issues", "changelog_uri" => "https://github.com/googleapis/google-api-ruby-client/tree/main/generated/google-apis-storage_v1/CHANGELOG.md", "documentation_uri" => "https://googleapis.dev/ruby/google-apis-storage_v1/v0.10.0", "source_code_uri" => "https://github.com/googleapis/google-api-ruby-client/tree/main/generated/google-apis-storage_v1" } if s.respond_to? :metadata=
  ...
  s.summary = "Simple REST client for Cloud Storage JSON API V1".freeze
