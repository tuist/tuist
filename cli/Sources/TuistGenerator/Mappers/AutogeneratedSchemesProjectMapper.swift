...
public struct AutogeneratedSchemesProjectMapper: ProjectMapping { // swiftlint:disable:this type_body_length
    ...
    private let testsInsightsDisabled: Bool
    private let buildInsightsActionMapper: BuildInsightsActionMapping
    private let testsInsightsActionMapper: TestsInsightsActionMapping
    ...
    init(
        ...
        testsInsightsActionMapper: TestsInsightsActionMapping
    ) {
        ...
        self.testsInsightsActionMapper = testsInsightsActionMapper
    }
    ...
    private func createDefaultScheme(
        ...
        let testAction = try await testableTargets.isEmpty ? nil : testsInsightsActionMapper.map(TestAction(
