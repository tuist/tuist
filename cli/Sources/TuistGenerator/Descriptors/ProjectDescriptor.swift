...
public struct ProjectDescriptor {
    ...
    /// Test plans whose `.xctestplan` files are generated by Tuist.
    /// Written after the `.xcodeproj` so that target blueprint identifiers are stable.
    public var testPlanDescriptors: [TestPlanDescriptor]
    ...
    public init(
        ...
        testPlanDescriptors: [TestPlanDescriptor] = []
    ) {
        self.path = path
