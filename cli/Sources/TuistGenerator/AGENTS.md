...
- Preserve generated sources, Info.plists, and entitlements during early Derived cleanup so unchanged files retain their mtimes. After their generating mappers run, describe stale-file cleanup from the mapped targets; execution removes only obsolete Tuist-owned files.
