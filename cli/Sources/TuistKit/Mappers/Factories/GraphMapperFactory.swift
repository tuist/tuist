...
public final class GraphMapperFactory: GraphMapperFactorying {
    ...
    public func automation(
        ...
        mappers.append(TreeShakePrunedTargetsGraphMapper(cacheKeepSourceTargets: Self.cacheKeepSourceTargets(config: config)))
    ...
    final class CacheGraphMapperFactory {
        ...
        func automation(
            ...
            mappers
                .append(TreeShakePrunedTargetsGraphMapper(cacheKeepSourceTargets: GraphMapperFactory
                        .cacheKeepSourceTargets(config: config)
                ))
            ...
            // Apply workspace and external project mappers
            mappers.append(UpdateWorkspaceProjectsGraphMapper())
            mappers.append(ExternalProjectsPlatformNarrowerGraphMapper())
            mappers.append(PruneOrphanExternalTargetsGraphMapper())
        ...
        func generation(
            ...
            mappers.append(TreeShakePrunedTargetsGraphMapper(cacheKeepSourceTargets:
                ignoreBinaryCache ? GraphMapperFactory.cacheKeepSourceTargets(config: config) : false
            ))
            ...
            if !ignoreBinaryCache {
                ...
                mappers.append(focusTargetsGraphMapper)
                mappers.append(TreeShakePrunedTargetsGraphMapper(cacheKeepSourceTargets: false))
            }
