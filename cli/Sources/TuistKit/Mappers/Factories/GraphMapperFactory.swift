...
public final class GraphMapperFactory: GraphMapperFactorying {
    ...
    final class CacheGraphMapperFactory {
        ...
        func automation(
            ...
            mappers.append(AutogeneratedWorkspaceSchemeGraphMapper(
            ...
            mappers.append(ExternalProjectsPlatformNarrowerGraphMapper())
            mappers.append(PruneOrphanExternalTargetsGraphMapper())
            mappers.append(TestsCacheGraphMapper(
                testPlan: testPlan,
                includedTargets: includedTargets,
                excludedTargets: excludedTargets,
            ...
            if !ignoreBinaryCache {
                mappers.append(TargetsToCacheBinariesGraphMapper(
                    config: config,
            ...
            mappers.append(AutogenerateTuistGenerateSchemeMapper(
                includeGenerateScheme: config.project.generatedProject?.generationOptions.includeGenerateScheme ?? false
            ))
