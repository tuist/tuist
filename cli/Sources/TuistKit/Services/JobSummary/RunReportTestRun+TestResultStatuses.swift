...
extension RunReportTestRun {
    ...
    init(scheme: String, testStatuses: TestResultStatuses, skippedTestModules: Int?) {
        self.init(
            scheme: scheme,
            ...
            ranTestModules: Set(testStatuses.testCases.compactMap(\.module)).count,
            skippedTestModules: skippedTestModules
        )
    }
}
