    ...
    func run(
        ...
        if try await manifestLoader.hasRootManifest(at: path) {
            ...
            Logger.current.info(
                ...
                Xcode Cache is set up. For projects not generated by Tuist, add the compilation-cache
                build settings from the Xcode cache docs:
                https://tuist.dev/en/docs/guides/features/cache/xcode-cache
                """
            )
        }
    }
