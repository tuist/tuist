    ...
    func map(
        ...
        let workspace = Workspace(
            ...
            generationOptions: .init(
                ...
                autogeneratedWorkspaceSchemes: .enabled(codeCoverageMode: .disabled, parallelization: .none, randomExecutionOrdering: false, testLanguage: nil, testRegion: nil, testScreenCaptureFormat: nil),
