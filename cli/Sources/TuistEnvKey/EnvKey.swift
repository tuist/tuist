...
public enum EnvKey: String, CaseIterable {
    ...
    case inspectDependenciesPath = "TUIST_INSPECT_DEPENDENCIES_PATH"
    case inspectDependenciesOnly = "TUIST_INSPECT_DEPENDENCIES_ONLY"
    ...
    case testStressNewTests = "TUIST_TEST_STRESS_NEW_TESTS"
    case testCoverage = "TUIST_TEST_COVERAGE"

    // TEST SHOW

    case testShowId = "TUIST_TEST_SHOW_ID"
    case testShowProject = "TUIST_TEST_SHOW_PROJECT"
    ...
    case testCaseRunListTestRunId = "TUIST_TEST_CASE_RUN_LIST_TEST_RUN_ID"
    ...
    public func envValue<T: ExpressibleByArgument>() -> T? {
