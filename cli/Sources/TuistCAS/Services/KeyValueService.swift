    ...
    public struct KeyValueService: CompilationCacheService_Keyvalue_V1_KeyValueDB.SimpleServiceProtocol {
        ...
        /// This parsing is a bit tricky. Ideally, we would have a more type-safe way to parse this, but the way entry is encoded
        /// is
        ...
        private func findNextCASEntry(
            in data: Data,
            startingAt offset: Int
        ) -> (casOffset: Int, hexOffset: Int, nextOffset: Int)? {
