    ...
    enum InspectBuildCommandServiceError: Equatable, LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .missingFullHandle:
                return
                    "The 'Tuist.swift' file is missing a fullHandle. See how to set up a Tuist project at: https://tuist.dev/en/docs/server/introduction/accounts-and-projects#projects"
            case .executablePathMissing:
