...
extension XcodeGraph.Workspace.GenerationOptions {
    ...
    static func from(
        ...
        .init(
            ...
            derivedDataPath: .from(manifest: manifest.derivedDataPath)
        )
    }
}
...
extension XcodeGraph.Workspace.GenerationOptions.DerivedDataPath {
    static func from(
        manifest: ProjectDescription.Workspace.GenerationOptions.DerivedDataPath
    ) -> Self {
        switch manifest {
        case .default: return .default
        case let .custom(path): return .custom(path.pathString)
        }
    }
}
