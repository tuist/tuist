...
struct BuildConfigurationTests {
    ...
    @Test func name_returnsTheRightValue_whenDebug() {
        #expect(BuildConfiguration.debug.name == "Debug")
    }

    @Test func name_returnsTheRightValue_whenRelease() {
        #expect(BuildConfiguration.release.name == "Release")
    }

    @Test func test_hashValue() {
        #expect(BuildConfiguration(name: "Debug", variant: .debug).hashValue == BuildConfiguration(name: "Debug", variant: .debug)
            .hashValue)
