...
public struct Workspace: Equatable, Codable {
    ...
    /// Resolved project paths in the order declared by the workspace manifest.
    ///
    /// Unlike ``projects``, this list is not expanded when graph loading discovers transitive projects.
    public var manifestProjectPaths: [AbsolutePath]
    ...
    public init(
        ...
        manifestProjectPaths: [AbsolutePath]? = nil,
        schemes: [Scheme] = [],
        ...
        self.manifestProjectPaths = manifestProjectPaths ?? projects
