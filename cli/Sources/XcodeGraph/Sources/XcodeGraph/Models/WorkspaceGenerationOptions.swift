...
extension Workspace {
    ...
    public struct GenerationOptions: Codable, Equatable {
        /// The order in which projects are rendered in the generated workspace.
        public enum ProjectsOrder: Codable, Equatable {
            /// Projects are ordered alphabetically.
            case alphabetical
            /// Projects are ordered as declared in the workspace manifest.
            case manifestOrder
        }
        ...
        /// The order in which projects are rendered in the generated workspace.
        public let projectsOrder: ProjectsOrder
        ...
        public init(
            ...
            projectsOrder: ProjectsOrder = .alphabetical
        ) {
