...
public struct Project: Codable, Equatable, Sendable {
    ...
    /// Trait selections for native packages. An absent package uses its default traits, while an empty array disables them.
    /// Package traits require Xcode 26.4 or later.
    public let packageTraits: [PackageTraitSelection]?
