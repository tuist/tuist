...
public struct TargetScript: Codable, Equatable, Sendable { // swiftlint:disable:this type_body_length
    ...
    /// List of output file paths. They can point to non-existent files that will be generated by the script.
    ...
    ///   - outputPaths: List of output file paths. They can point to non-existent files that will be generated by the script.
