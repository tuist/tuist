...
public struct Client: APIProtocol {
    ...
    /// Get a test case by name components.
    ///
    /// - Remark: HTTP `GET /api/projects/{account_handle}/{project_handle}/tests/test-cases/lookup`.
    /// - Remark: Generated from `#/paths//api/projects/{account_handle}/{project_handle}/tests/test-cases/lookup/get(showTestCaseByName)`.
    public func showTestCaseByName(_ input: Operations.showTestCaseByName.Input) async throws -> Operations.showTestCaseByName.Output {
        try await client.send(
            input: input,
            forOperation: Operations.showTestCaseByName.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/api/projects/{}/{}/tests/test-cases/lookup",
                    parameters: [
                        input.path.account_handle,
                        input.path.project_handle
                    ]
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.showTestCaseByName.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Operations.showTestCaseByName.Output.Ok.Body.jsonPayload.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
                ...
                case 403:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.showTestCaseByName.Output.Forbidden.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                ...
                case 404:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.showTestCaseByName.Output.NotFound.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    /// List test case runs by name components.
    ///
