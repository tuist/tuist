...
public struct Client: APIProtocol {
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Operations.listTestCaseRunsByTestCase.Output.Ok.Body.jsonPayload.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Operations.listTestCaseRuns.Output.Ok.Body.jsonPayload.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
    ...
    /// Get a presigned download URL for a test case run attachment.
    ///
    /// - Remark: HTTP `GET /api/projects/{account_handle}/{project_handle}/tests/test-case-runs/{test_case_run_id}/attachments/{file_name}`.
    /// - Remark: Generated from `#/paths//api/projects/{account_handle}/{project_handle}/tests/test-case-runs/{test_case_run_id}/attachments/{file_name}/get(downloadTestCaseRunAttachment)`.
    public func downloadTestCaseRunAttachment(_ input: Operations.downloadTestCaseRunAttachment.Input) async throws -> Operations.downloadTestCaseRunAttachment.Output {
        try await client.send(
            input: input,
            forOperation: Operations.downloadTestCaseRunAttachment.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/api/projects/{}/{}/tests/test-case-runs/{}/attachments/{}",
                    parameters: [
                        input.path.account_handle,
                        input.path.project_handle,
                        input.path.test_case_run_id,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.downloadTestCaseRunAttachment.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Operations.downloadTestCaseRunAttachment.Output.Ok.Body.jsonPayload.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
                ...
                case 403:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.downloadTestCaseRunAttachment.Output.Forbidden.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                ...
                case 404:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.downloadTestCaseRunAttachment.Output.NotFound.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
        ...
        try await client.send(
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Operations.listTestCaseRunsByTestRun.Output.Ok.Body.jsonPayload.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
