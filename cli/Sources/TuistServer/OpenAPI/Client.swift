...
public struct Client: APIProtocol {
    ...
    public func getRunJobSummary(_ input: Operations.getRunJobSummary.Input) async throws -> Operations.getRunJobSummary.Output {
        try await client.send(
            input: input,
            forOperation: Operations.getRunJobSummary.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/api/projects/{}/{}/runs/job-summary",
                    parameters: [
                        input.path.account_handle,
                        input.path.project_handle
                    ]
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.getRunJobSummary.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Components.Schemas.RunJobSummary.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
                ...
                case 401:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.getRunJobSummary.Output.Unauthorized.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                ...
                case 403:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.getRunJobSummary.Output.Forbidden.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
