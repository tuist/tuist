...
public protocol GetBuildServicing {
    func getBuild(
        ...
        buildId: String,
        serverURL: URL
    ) async throws -> Components.Schemas.BuildRunRead
}
...
enum GetBuildServiceError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case let .unknownError(statusCode):
            return "The build could not be retrieved due to an unknown Tuist response of \(statusCode)."
        }
    }
}
...
public final class GetBuildService: GetBuildServicing {
    ...
    public func getBuild(
        ...
        case let .unauthorized(unauthorized):
            ...
            case let .json(error):
                throw GetBuildServiceError.unauthorized(error.message)
            }
