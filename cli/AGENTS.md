...
## Key Boundaries
- Entry points and command wiring live in `cli/Sources/tuist` and `cli/Sources/TuistKit`.
...
- Integration surfaces live in:
  - Tuist Server: `cli/Sources/TuistServer`
  - Cache: `cli/Sources/TuistCache`
  - Dependencies: `cli/Sources/TuistDependencies`
  - Manifests/loading: `cli/Sources/TuistLoader`
