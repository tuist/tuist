...
struct ServerClientCLIMetadataHeadersMiddlewareTests {
    @Test func sends_local_development_version_when_cli_version_is_the_placeholder() async throws {
        ...
        let (gotResponse, _) = try await Constants.$version.withValue("x.y.z") {
        ...
        #expect(gotRequest?.headerFields[cliVersionHeaderName] == "4.202.0-canary.21")
    }
