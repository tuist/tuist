...
final class TargetScriptManifestMapperTests: TuistUnitTestCase {
    ...
    func test_doesntGlob_whenNotGlobPattern_andPreservesMissingOutputPath() async throws {
        // Given
        let temporaryPath = try temporaryPath()
        let rootDirectory = temporaryPath
        let generatorPaths = GeneratorPaths(
        ...
        // Intentionally do not create this file to verify that non-glob output
        // paths are preserved even when they don't exist at generate time.
        let missingOutputPath = "Generated/Build/AutoGenerated.swift"
