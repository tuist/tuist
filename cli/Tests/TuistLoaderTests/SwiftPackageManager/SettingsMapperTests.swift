...
struct SettingsMapperTests {
    @Test func set_defaults() throws {
        ...
        #expect(resolvedSettings.isEmpty)
    }

    @Test func set_GCC_PREPROCESSOR_DEFINITIONS() throws {
    ...
    @Test func set_SWIFT_OBJC_INTEROP_MODE_when_cplusplus() throws {
        let settings: [PackageInfo.Target.TargetBuildSettingDescription.Setting] = [
    ...
    @Test func set_SWIFT_OBJC_INTEROP_MODE_when_c() throws {
        let settings: [PackageInfo.Target.TargetBuildSettingDescription.Setting] = [
    ...
    @Test func set_HEADER_SEARCH_PATHS() throws {
        let settings: [PackageInfo.Target.TargetBuildSettingDescription.Setting] = [
    ...
    @Test func set_OTHER_CFLAGS() throws {
        let settings: [PackageInfo.Target.TargetBuildSettingDescription.Setting] = [
    ...
    @Test func set_OTHER_CPLUSPLUSFLAGS() throws {
        let settings: [PackageInfo.Target.TargetBuildSettingDescription.Setting] = [
    ...
    @Test func set_OTHER_SWIFT_FLAGS() throws {
        let settings: [PackageInfo.Target.TargetBuildSettingDescription.Setting] = [
    ...
    @Test func set_OTHER_LDFLAGS() throws {
        let settings: [PackageInfo.Target.TargetBuildSettingDescription.Setting] = [
    ...
    @Test func set_SWIFT_VERSION() throws {
        let settings: [PackageInfo.Target.TargetBuildSettingDescription.Setting] = [
    ...
    @Test func strict_memory_safety_warnings() throws {
        let settings: [PackageInfo.Target.TargetBuildSettingDescription.Setting] = [
    ...
    @Test func strict_memory_safety_errors() throws {
        let settings: [PackageInfo.Target.TargetBuildSettingDescription.Setting] = [
    ...
    @Test func set_OTHER_CPLUSPLUSFLAGS_with_disableWarning() throws {
        let settings: [PackageInfo.Target.TargetBuildSettingDescription.Setting] = [
    ...
    @Test func set_OTHER_SWIFT_FLAGS_with_disableWarning() throws {
        let settings: [PackageInfo.Target.TargetBuildSettingDescription.Setting] = [
...
extension XcodeGraph.SettingsDictionary {
    ...
    func arrayValueFor(_ key: String) throws -> [String] {
        try #require(self[key]?.arrayValue)
    }
}

extension XcodeGraph.SettingValue {
    var stringValue: String? {
        if case let .string(string) = self { return string } else { return nil }
    }

    var arrayValue: [String]? {
        if case let .array(array) = self { return array } else { return nil }
    }
}
