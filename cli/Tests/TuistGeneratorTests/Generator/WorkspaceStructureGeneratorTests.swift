...
final class WorkspaceStructureGeneratorTests: XCTestCase {
    ...
    func test_generateStructure_addsDependenciesToADependenciesGroup() async throws {
        // Given
        let xcodeProjPaths = try createFolders([
            "/path/to/workspace/Tuist/.build/tuist-derived/Projects/AEXML/AEXML.xcodeproj",
            "/path/to/workspace/Tuist/.build/tuist-derived/Projects/SwiftSyntax/SwiftSyntax.xcodeproj",
        ])
        ...
        XCTAssertEqual(structure.contents, [
            .virtualGroup(name: "Dependencies", contents: [
                .project("/path/to/workspace/Tuist/.build/tuist-derived/Projects/AEXML/AEXML.xcodeproj"),
                .project(
                    "/path/to/workspace/Tuist/.build/tuist-derived/Projects/SwiftSyntax/SwiftSyntax.xcodeproj"
                ),
            ]),
