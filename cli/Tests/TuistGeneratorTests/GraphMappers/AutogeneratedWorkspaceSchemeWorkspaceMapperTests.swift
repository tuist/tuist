...
struct AutogeneratedWorkspaceSchemeWorkspaceMapperTests {
    ...
    func test_map() async throws {
        ...
        #expect(try #require(scheme.testAction?.coverage) == false)
    }

    @Test(.inTemporaryDirectory)
    func map_when_binary_sources() async throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeGraphMapper(
            forceWorkspaceSchemes: false,
            buildInsightsDisabled: true,
    ...
    @Test(.inTemporaryDirectory)
    func map_disabled() async throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeGraphMapper(
            forceWorkspaceSchemes: false,
    ...
    @Test(.inTemporaryDirectory)
    func map_disabled_but_forced() async throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeGraphMapper(
    ...
    @Test(.inTemporaryDirectory)
    func multiple_project_sorting() async throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeGraphMapper(
            forceWorkspaceSchemes: false,
            buildInsightsDisabled: true,
    ...
    @Test(.inTemporaryDirectory)
    func map_when_multiple_platforms() async throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeGraphMapper(
            forceWorkspaceSchemes: false,
            buildInsightsDisabled: true,
    ...
    @Test(.inTemporaryDirectory)
    func map_codeCoverage_disabled() async throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeGraphMapper(
            forceWorkspaceSchemes: false,
            buildInsightsDisabled: true,
    ...
    @Test(.inTemporaryDirectory)
    func map_codeCoverageMode_all() async throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeGraphMapper(
            forceWorkspaceSchemes: false,
            buildInsightsDisabled: false,
    ...
    @Test(.inTemporaryDirectory)
    func map_when_build_insights_are_enabled() async throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeGraphMapper(
            forceWorkspaceSchemes: false,
            buildInsightsDisabled: false,
    ...
    @Test(.inTemporaryDirectory)
    func map_codeCoverageMode_targets() async throws {
        // Given
        let targetA = Target.test(
            name: "A"
        )
    ...
    @Test(.inTemporaryDirectory)
    func map_codeCoverageMode_relevant_nonEmpty() async throws {
        // Given
        let targetA = Target.test(
            name: "A"
        )
    ...
    @Test(.inTemporaryDirectory)
    func map_codeCoverageMode_relevant_complex() async throws {
        // Given
        let targetA = Target.test(
            name: "A"
        )
    ...
    @Test(.inTemporaryDirectory)
    func map_codeCoverageMode_relevant_empty() async throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeGraphMapper(
            forceWorkspaceSchemes: false,
            buildInsightsDisabled: false,
    ...
    @Test(.inTemporaryDirectory)
    func map_testing_options_all() async throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeGraphMapper(
            forceWorkspaceSchemes: false,
            buildInsightsDisabled: true,
    ...
    @Test(.inTemporaryDirectory)
    func map_language_region() async throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeGraphMapper(
            forceWorkspaceSchemes: false,
            buildInsightsDisabled: true,
    ...
    @Test(.inTemporaryDirectory)
    func map_preferredScreenCaptureFormat() async throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeGraphMapper(
            forceWorkspaceSchemes: false,
            buildInsightsDisabled: true,
