...
final class AutogeneratedSchemesProjectMapperTests: TuistUnitTestCase {
    ...
    private var testsInsightsActionMapper: MockTestsInsightsActionMapping!

    override func setUp() {
        super.setUp()

        buildInsightsActionMapper = MockBuildInsightsActionMapping()
        testsInsightsActionMapper = MockTestsInsightsActionMapping()
        ...
        subject = AutogeneratedSchemesProjectMapper(
            ...
            testsInsightsActionMapper: testsInsightsActionMapper
        )
