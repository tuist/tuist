...
final class MockXcodeBuildController: XcodeBuildControlling {
    var buildStub:
        (
            (XcodeBuildTarget, String, Bool, [XcodeBuildArgument]) -> Observable<
    ...
    var testStub:
        (
            (
                XcodeBuildTarget, String, Bool, XcodeBuildDestination, AbsolutePath?, AbsolutePath?,
                [XcodeBuildArgument]
            ) -> Observable<SystemEvent<XcodeBuildOutput>>
    ...
    var archiveStub:
        (
            (XcodeBuildTarget, String, Bool, AbsolutePath, [XcodeBuildArgument]) -> Observable<
                SystemEvent<XcodeBuildOutput>
            >
        )?
    func archive(
    ...
    var createXCFrameworkStub:
        (([AbsolutePath], AbsolutePath) -> Observable<SystemEvent<XcodeBuildOutput>>)?
    ...
    var showBuildSettingsStub:
        ((XcodeBuildTarget, String, String) -> Single<[String: XcodeBuildSettings]>)?
