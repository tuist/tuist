...
public final class MockXCFrameworkMetadataProvider: MockPrecompiledMetadataProvider, XCFrameworkMetadataProviding {
    ...
    public func loadMetadata(at path: AbsolutePath, originalSignature: XcodeGraph.XCFrameworkOriginalSignatureType, status: LinkingStatus) throws -> XCFrameworkMetadata {
