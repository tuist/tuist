...
public final class MockCacheArtifactBuilder: CacheArtifactBuilding {
    ...
    public func build(scheme: Scheme, projectTarget: XcodeBuildTarget, configuration _: String, osVersion _: Version?, deviceName _: String?, into outputDirectory: AbsolutePath) throws {
