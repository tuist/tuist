...
extension CarthageVersionFile {
    ...
    /// using `carthage bootstrap --platform iOS,macOS,tvOS,watchOS --use-xcframeworks --no-use-binaries --use-netrc
    /// --cache-builds --new-resolver` command
    ...
    /// that was generated by `Carthage` in` `0.37.0` version
    /// using `carthage bootstrap --platform iOS --use-xcframeworks --no-use-binaries --use-netrc --cache-builds --new-resolver`
    /// command
