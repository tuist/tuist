...
extension XcodeProjectGenerator.InfoPlist {
    /// Maps a ProjectDescription.InfoPlist instance into a XcodeProjectGenerator.InfoPlist instance.
    /// - Parameters:
    ///   - manifest: Manifest representation of the Info plist model.
    ///   - generatorPaths: Generator paths.
    static func from(manifest: ProjectDescription.InfoPlist?, generatorPaths: GeneratorPaths) throws -> XcodeProjectGenerator.InfoPlist? {
        switch manifest {
