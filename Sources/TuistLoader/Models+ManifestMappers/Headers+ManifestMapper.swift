...
extension XcodeProjectGenerator.Headers {
    /// Maps a ProjectDescription.Headers instance into a XcodeProjectGenerator.Headers model.
    ...
    static func from( // swiftlint:disable:this function_body_length
        ...
        productName: String?
    ) throws -> XcodeProjectGenerator.Headers {
        ...
        let allowedExtensions = XcodeProjectGenerator.Headers.extensions
        func unfold(
            _ list: FileList?,
            isPublic: Bool = false
        ) throws -> [AbsolutePath] {
