...
extension TuistGraph.Workspace.GenerationOptions {
    ...
    static func from(
        ...
        .init(
            automaticXcodeSchemes: .from(manifest: manifest.automaticXcodeSchemes),
...
extension TuistGraph.Workspace.GenerationOptions.AutomaticXcodeSchemes {
    ...
    static func from(manifest: ProjectDescription.Workspace.GenerationOptions.AutomaticXcodeSchemes) -> Self {
        switch manifest {
