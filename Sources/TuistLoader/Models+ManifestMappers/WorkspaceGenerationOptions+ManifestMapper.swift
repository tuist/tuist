...
extension XcodeProjectGenerator.Workspace.GenerationOptions {
    /// Maps ProjectDescription.Workspace.GenerationOptions instance into a XcodeProjectGenerator.Workspace.GenerationOptions model.
    /// - Parameters:
...
extension XcodeProjectGenerator.Workspace.GenerationOptions.AutogeneratedWorkspaceSchemes {
    static func from(
        ...
        case .disabled:
            return .disabled
        case let .enabled(codeCoverageMode, testingOptions, testLanguage, testRegion, testScreenCaptureFormat):
            return .enabled(
...
extension XcodeProjectGenerator.Workspace.GenerationOptions.AutogeneratedWorkspaceSchemes.CodeCoverageMode {
    static func from(
        ...
        case let .targets(targets):
            let targets: [XcodeProjectGenerator.TargetReference] = try targets.map {
                .init(
