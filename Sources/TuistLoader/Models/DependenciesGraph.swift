        ...
        public static func googleAppMeasurement(
            ...
            let targets: [Target] = [
                .target(
                    ...
                    dependencies: [
                        .xcframework(path: "\(artifactsFolder.pathString)/GoogleAppMeasurement.xcframework", expectedSignature: .unsigned),
                        .project(
                ...
                .target(
                    ...
                    dependencies: [
                        .xcframework(
                            path: "\(artifactsFolder.pathString)/GoogleAppMeasurementWithoutAdIdSupport.xcframework", expectedSignature: .unsigned
                        ),
                        .project(
                            target: "GULAppDelegateSwizzler",
                            path: Self.packageFolder(spmFolder: spmFolder, packageName: "GoogleUtilities")
