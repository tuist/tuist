...
class UpEnvironmentExists: UpRequired, GraphInitiatable {
    let variable: String
    ...
    override func meet(projectPath _: AbsolutePath) throws {
        throw CheckRequirementError.unfulfilled("The variable \(variable) does not exist.")
    }
    ...
    override func isMet(projectPath _: AbsolutePath) throws -> Bool {
        return System.shared.env[variable] != nil
    }
}
