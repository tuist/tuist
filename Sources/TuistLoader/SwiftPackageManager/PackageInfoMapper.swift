...
public protocol PackageInfoMapping {
    ...
    func map(
        ...
        packageSettings: XcodeProjectGenerator.PackageSettings,
...
public final class PackageInfoMapper: PackageInfoMapping {
    ...
    private func map(
        ...
        productTypes: [String: XcodeProjectGenerator.Product],
        productDestinations: [String: XcodeProjectGenerator.Destinations],
        baseSettings: XcodeProjectGenerator.Settings,
        targetSettings: [String: XcodeProjectGenerator.SettingsDictionary]
                ...
                let productDestinations: Set<ProjectDescription.Destination> = Set(
                    products.flatMap { product in
                        if product.type == .executable {
                            return Set([XcodeProjectGenerator.Destination.mac])
                        }
...
extension ProjectDescription.Product {
    fileprivate static func from(product: XcodeProjectGenerator.Product) -> Self {
        switch product {
        case .app:
            return .app
        case .staticLibrary:
...
extension ProjectDescription.SettingsDictionary {
    public static func from(settingsDictionary: XcodeProjectGenerator.SettingsDictionary) -> Self {
...
extension ProjectDescription.Configuration {
    public static func from(
        buildConfiguration: BuildConfiguration,
        configuration: XcodeProjectGenerator.Configuration?,
        packageFolder: AbsolutePath
    ) -> Self {
...
extension ProjectDescription.DefaultSettings {
    fileprivate static func from(defaultSettings: XcodeProjectGenerator.DefaultSettings) -> Self {
