...
public protocol TemplateGitLoading {
    ...
    func loadTemplate(from templateURL: String, closure: (TuistModels.Template) throws -> Void) throws
}
...
public final class TemplateGitLoader: TemplateGitLoading {
    ...
    public func loadTemplate(from templateURL: String, closure: (TuistModels.Template) throws -> Void) throws {
