...
protocol ProjectDescriptionHelpersBuilding: AnyObject {
    ...
    ///   - customProjectDescriptionHelpers: List of custom project description helpers to build.
    func build(
        at path: AbsolutePath,
        projectDescriptionSearchPaths: ProjectDescriptionSearchPaths,
        customProjectDescriptionHelpers: [CustomProjectDescriptionHelpers]
...
final class ProjectDescriptionHelpersBuilder: ProjectDescriptionHelpersBuilding {
    ...
    func build(
        ...
        let customHelpers = try customProjectDescriptionHelpers.map {
    ...
    private func createCommand(
        ...
        customProjectDescriptionHelperModules.forEach {
