...
enum CloudClientOutputWarningsMiddlewareError: FatalError {
    ...
    var description: String {
        switch self {
        case .couldntConvertToData:
            "We couldn't convert Tuist Cloud warnings into a data instance"
        case .invalidSchema:
            "The Tuist Cloud warnings returned by the server have an unexpected schema"
        }
    }
...
struct CloudClientOutputWarningsMiddleware: ClientMiddleware {
