...
public final class CloudSessionController: CloudSessionControlling {
    ...
    public convenience init() {
        ...
        self.init(
            ...
            cloudAuthenticationController: CloudAuthenticationController(credentialsStore: credentialsStore)
        )
    }

    init(
        credentialsStore: CloudCredentialsStoring,
    ...
    public func printSession(serverURL: URL) throws {
        if let token = try cloudAuthenticationController.authenticationToken(serverURL: serverURL) {
            switch token {
