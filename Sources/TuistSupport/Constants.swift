...
public enum Constants {
    ...
    public static let version = "3.33.3"
    ...
    public enum EnvironmentVariables {
        ...
        /// Default URL for Tuist Cloud
        public static let cloudURL = "TUIST_CLOUD_URL"
        /// Binary path to the `xcbeautify` executable
        public static let xcbeautifyBinaryPath = "TUIST_CONFIG_XCBEAUTIFY_BINARY_PATH"
    }
