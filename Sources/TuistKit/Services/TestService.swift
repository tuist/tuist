...
final class TestService {
    ...
    func run(
        ...
        let testableSchemes = buildGraphInspector.testableSchemes(graphTraverser: graphTraverser) +
            buildGraphInspector.workspacesSchemes(graphTraverser: graphTraverser)
        logger.log(
            level: .debug,
        ...
        if let schemeName = schemeName {
            ...
            let testSchemes: [Scheme] = buildGraphInspector.workspacesSchemes(graphTraverser: graphTraverser)
                .filter {
