...
final class CacheWarmService {
    ...
    func run(path: String?, profile: String?, xcframeworks: Bool, targets: [String], continueOnError: Bool) throws {
        ...
        try cacheController.cache(path: path, cacheProfile: profile, targetsToFilter: targets, continueOnError: continueOnError)
    }
