...
final class WorkspaceMapperFactory: WorkspaceMapperFactorying {
    ...
    func automation(config: Config, workspaceDirectory: AbsolutePath) -> [WorkspaceMapping] {
        ...
        switch config.autogeneratedWorkspaceOptions {
    ...
    func `default`(config: Config) -> [WorkspaceMapping] {
        ...
        case let .enabled(codeCoverageMode, testingOptions):
            mappers.append(
                AutogeneratedWorkspaceSchemeWorkspaceMapper(codeCoverageMode: codeCoverageMode, testingOptions: testingOptions)
            )
        case .disabled:
            break
        }
