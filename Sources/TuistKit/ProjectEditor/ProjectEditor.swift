...
final class ProjectEditor: ProjectEditing {
    ...
    /// Utitily to locate `Config.swift` file
    ...
    init(
        ...
        setupLocator: SetupLocating = SetupLocator(),
        configLocator: ConfigLocating = ConfigLocator(),
    ...
    func edit(at: AbsolutePath, in dstDirectory: AbsolutePath) throws -> AbsolutePath {
        ...
        let setupPath = setupLocator.locate(at: at)
        let configPath = configLocator.locate(at: at)
