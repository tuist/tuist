...
public struct Config: Codable, Equatable {
    ...
    public enum GenerationOptions: Codable, Equatable {
        ...
        /// Tuist will not generate **{Project}-Project** workspace scheme
        case disableProjectScheme
...
extension Config.GenerationOptions {
    ...
    public init(from decoder: Decoder) throws {
        ...
        } else if container.allKeys.contains(.disableProjectScheme), try container.decode(Bool.self, forKey: .disableProjectScheme) {
            self = .disableProjectScheme
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .disableProjectScheme:
            try container.encode(true, forKey: .disableProjectScheme)
        case .disableSynthesizedResourceAccessors:
