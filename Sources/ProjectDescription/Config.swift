...
public struct Config: Codable, Equatable {
    ...
    /// - disableAutogeneratedNamespace: When passed, Tuist does not generate namespace for your resources
...
extension Config.GenerationOptions {
    enum CodingKeys: String, CodingKey {
        case xcodeProjectName, organizationName, disableAutogeneratedSchemes, disableAutogeneratedNamespace
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        if try container.decode(Bool.self, forKey: .disableAutogeneratedNamespace) {
            self = .disableAutogeneratedNamespace
            return
        }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .disableAutogeneratedNamespace:
            try container.encode(true, forKey: .disableAutogeneratedNamespace)
        }
    }
}
