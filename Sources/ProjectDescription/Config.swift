...
public struct Config: Codable, Equatable {
    ...
    public enum GenerationOptions: Codable, Equatable {
        ...
        public enum AutogenerationOptions: Codable, Equatable {
            ...
            public struct TestingOptions: Codable, Equatable {
                /// The suffix of the targets to be grouped in the same scheme.
                public struct TargetGroupSuffixes: Codable, Equatable {
                ...
                public let customTargetGroupSuffixes: TargetGroupSuffixes
