...
public struct Config: Codable, Equatable {
    ...
    public enum GenerationOptions: Codable, Equatable {
        ...
        case fileHeaderTemplate(FileHeaderTemplate)
    }
...
extension Config.GenerationOptions {
    ...
    public init(from decoder: Decoder) throws {
        ...
        } else if container.allKeys.contains(.fileHeaderTemplate), try container.decodeNil(forKey: .fileHeaderTemplate) == false {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case let .fileHeaderTemplate(fileHeaderTemplate):
            var associatedValues = container.nestedUnkeyedContainer(forKey: .fileHeaderTemplate)
            try associatedValues.encode(fileHeaderTemplate)
        }
    }
}
