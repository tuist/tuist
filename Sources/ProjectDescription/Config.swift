...
extension Config.GenerationOptions {
    ...
    public init(from decoder: Decoder) throws {
        ...
        } else if container.allKeys.contains(.swiftToolsVersion), try container.decodeNil(forKey: .swiftToolsVersion) == false {
            var associatedValues = try container.nestedUnkeyedContainer(forKey: .swiftToolsVersion)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case let .swiftToolsVersion(version):
            var associatedValues = container.nestedUnkeyedContainer(forKey: .swiftToolsVersion)
