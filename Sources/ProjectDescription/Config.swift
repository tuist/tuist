...
extension Config.GenerationOptions {
    enum CodingKeys: String, CodingKey {
        case xcodeProjectName, organizationName, developmentRegion, disableAutogeneratedSchemes, disableSynthesizedResourceAccessors, disableShowEnvironmentVarsInScriptPhases
    }
