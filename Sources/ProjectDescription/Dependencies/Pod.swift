...
/// A Pod dependency.
///
/// A Pod dependency can be either:
...
extension Pod {
    ...
    public static func pod(url: String, from version: Version) -> Package {
        .pod(url: url, .upToNextMajor(from: version))
    }
    ...
    public static func pod(url: String, _ requirement: Package.Requirement) -> Package {
    ...
    public static func pod(url: String, _ range: Range<Version>) -> Package {
    ...
    public static func pod(url: String, _ range: ClosedRange<Version>) -> Package {
        ...
        return .pod(url: url, range.lowerBound ..< upperBound)
    }
    ...
    public static func pod(path: Path) -> Package {
        .local(path: path)
    }
}
