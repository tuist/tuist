extension Workspace {
    ...
    public struct GenerationOptions: Codable, Equatable {
        ...
        public var enableAutomaticXcodeSchemes: Bool? = false
        ...
        public var autogeneratedWorkspaceSchemes: AutogeneratedWorkspaceSchemes = .enabled()
