...
public extension XCTestCase {
    ...
    func XCTAssertContainsElementOfType<T>(_ collection: [Any], _ element: T.Type, file: StaticString = #file, line: UInt = #line) -> T? {
    ...
    func XCTAssertDoesntContainElementOfType<T>(_ collection: [Any], _ element: T.Type, file: StaticString = #file, line: UInt = #line) -> T? {
    ...
    func XCTAssertContainsElementOfType<T, U>(_ collection: [Any], _ element: T.Type, after: U.Type, file: StaticString = #file, line: UInt = #line) -> T? {
    ...
    func XCTAssertContainsElementOfType<T, U>(_ collection: [Any], _ element: T.Type, before: U.Type, file: StaticString = #file, line: UInt = #line) -> T? {
        guard let elementIndex = collection.firstIndex(where: { $0 is T }) else {
            XCTFail("Didn't found an element of type \(String(describing: element))", file: file, line: line)
            return nil
        }
