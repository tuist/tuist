...
class SchemeLinter: SchemeLinting {
    func lint(project: Project) -> [LintingIssue] {
        ...
        issues.append(contentsOf: lintCodeCoverageTargets(schemes: project.schemes, targets: Array(project.targets)))
        issues.append(contentsOf: lintExpandVariableTarget(schemes: project.schemes, targets: Array(project.targets)))
