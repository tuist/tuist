    ...
    public func map(project: Project) throws -> (Project, [SideEffectDescriptor]) {
        ...
        project.targets.forEach { target in
            ...
            case .framework, .staticLibrary, .dynamicLibrary, .staticFramework, .bundle, .appExtension, .watch2Extension,
                 .tvTopShelfExtension, .messagesExtension, .stickerPackExtension, .extensionKitExtension:
...
extension Product {
    var isExtension: Bool {
        switch self {
        case .appExtension, .watch2Extension, .tvTopShelfExtension, .messagesExtension, .stickerPackExtension, .extensionKitExtension:
            return true
