...
public final class AutogeneratedSchemesProjectMapper: ProjectMapping {
    ...
    public func map(project: Project) throws -> (Project, [SideEffectDescriptor]) {
        ...
        let autogeneratedSchemes = (
            targetGroupsSchemes + remainingBuildTargetsSchemes + remainingTestTargetsSchemes +
            ...
            testAction: testTargets.isEmpty ? nil : TestAction(
                targets: testTargets
                    .map {
                        ...
                        return TestableTarget(target: $0, parallelizable: parallel, randomExecutionOrdering: randomExecution)
                    }
