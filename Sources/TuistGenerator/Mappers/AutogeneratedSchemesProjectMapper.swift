...
public final class AutogeneratedSchemesProjectMapper: ProjectMapping {
                                 ...
                                 project: Project) -> [TestableTarget]
    {
        if target.product.testsBundle {
            return [TestableTarget(target: targetReference, parallelizable: target.parallelizableTests)]
        } else {
            ...
            return project.targets
                ...
                .map { TestableTarget(target: $0, parallelizable: target.parallelizableTests) }
        }
    }
