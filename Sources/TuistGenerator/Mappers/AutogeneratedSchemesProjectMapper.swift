...
public final class AutogeneratedSchemesProjectMapper: ProjectMapping {
    ...
    private func createDefaultScheme(target: Target, project: Project, config: TuistCore.Config, buildConfiguration: String) -> Scheme {
        ...
        let codeCoverageEnabled = config.generationOptions.contains(.enableCodeCoverage)
        let codeCoverageTargets = codeCoverageEnabled ? [targetReference] : []
