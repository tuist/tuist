...
public final class AutogeneratedProjectSchemeWorkspaceMapper: WorkspaceMapping { // swiftlint:disable:this type_name
    ...
    let testingOptions: AutogenerationOptions.TestingOptions
//    let autoCreateWorkspaceSchemes: Bool

    // MARK: - Init

    public init(
        codeCoverageMode: CodeCoverageMode?,
        testingOptions: AutogenerationOptions.TestingOptions
//        autoCreateWorkspaceSchemes: Bool
    ) {
        self.codeCoverageMode = codeCoverageMode
        self.testingOptions = testingOptions
//        self.autoCreateWorkspaceSchemes = autoCreateWorkspaceSchemes
    }
