...
public struct OtoolController: OtoolControlling {
    ...
    public func dylibDependenciesBinaryPath(forBinaryAt path: AbsolutePath) throws -> Single<[AbsolutePath]> {
...
private extension OtoolController {
    func parseOtoolOutput(filePath: AbsolutePath, output: String) throws -> [AbsolutePath] {
        ...
        return outputByNewLines
            .dropFirst() // first line is the path to the framework as a header
            .dropFirst() // second line is the path to the framework
