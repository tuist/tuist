...
enum DefaultConfigurationFetcherError: FatalError, Equatable {
    ...
    var description: String {
        ...
        case let .defaultConfigurationNotFound(configuration, available):
            return "We couldn't find the default configuration \(configuration) specified in your Tuist.swift in the project. The configurations available are: \(available.joined(separator: ", "))"
        }
    }
}
