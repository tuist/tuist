...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/TamarMilchtaich/XcodeProj", branch: "xcframeworks-expected-signature"),
        ...
        .package(url: "https://github.com/TamarMilchtaich/XcodeGraph", branch: "xcframeworks-expected-signature"),
        .package(url: "https://github.com/tuist/FileSystem.git", .upToNextMajor(from: "0.7.8")),
        .package(url: "https://github.com/TamarMilchtaich/Command.git", branch: "non-throwing-concatenated-string"),
