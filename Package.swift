...
let package = Package(
    ...
    targets: [
        .target(
            name: "TuistCore",
            dependencies: [swiftToolsSupportDependency, "TuistSupport", "XcodeProj", "Checksum", "RxSwift", rxBlockingDependency]
        ),
        .target(
        ...
        .testTarget(
            ...
            dependencies: ["TuistCore", "TuistLoader", "TuistSupportTesting"]
        ),
        .target(
            name: "TuistDoc",
            dependencies: [
