...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/tuist/XcodeProj", .upToNextMajor(from: "8.7.1")),
        .package(name: "Signals", url: "https://github.com/tuist/BlueSignals", .upToNextMajor(from: "1.0.21")),
