defmodule TuistWeb.StructuredMarkup do
  ...
  def get_blog_structured_markup_data(posts) do
    %{
      ...
      "publisher" => TuistWeb.StructuredMarkup.get_organization_structured_data()
    }
  end
  ...
  def get_blog_post_structured_markup_data(post) do
    %{
      ...
      "author" => %{
        "@type" => "Person",
        "name" => Tuist.Blog.get_post_author(post)["name"],
        "url" => "https://github.com/#{Tuist.Blog.get_post_author(post)["github_handle"]}"
      },
      "publisher" => TuistWeb.StructuredMarkup.get_organization_structured_data(),
