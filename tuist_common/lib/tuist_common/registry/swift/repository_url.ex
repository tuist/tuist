defmodule TuistCommon.Registry.Swift.RepositoryURL do
  @moduledoc """
  Parses upstream Git URLs into `{scope, name}` repository handles used
  by the Swift package registry. Shared between the sync workers and
  the standalone registry read frontend.
  """
