Feature: Install dependencies Tuist.
    ...
    Scenario: The project is an application with framework and tests and Dependencies.swift (app_with_framework_and_tests_and_dependencies)
        ...
        Then a directory Tuist/Dependencies/Carthage/Build exists
        Then a directory Tuist/Dependencies/Carthage/Alamofire/macOS/Alamofire.framework exists
        Then a directory Tuist/Dependencies/Carthage/Swinject/macOS/Swinject.framework exists
