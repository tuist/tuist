...
- `tuist migration list-targets` command to list the targets of a project sorted by number of dependencies [#1732]((https://github.com/tuist/tuist/pull/1732)) by [@andreacipriani](https://github.com/andreacipriani)
