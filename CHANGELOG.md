...
- Removed filtering of the environment variables exposed to shell commands [#xxxx](https://github.com/tuist/tuist/pull/xxxx) by [@kalkwarf](https://github.com/kalkwarf)
