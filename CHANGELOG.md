...
- Using `.disableAutogeneratedSchemes` remove project scheme no more, use `.disableProjectScheme` to do so [#3364](https://github.com/tuist/tuist/pull/3364) by [@olejnjak](https://github.com/olejnjak)
