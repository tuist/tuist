...
- Add `enableCodeCoverage` configuration option to enable code coverage in automatically generated schemes [#ZZZZ](https://github.com/tuist/tuist/pull/ZZZZ) by [@frijole](https://github.com/frijole).)
