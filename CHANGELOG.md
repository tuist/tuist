...
- Fixed issue where associating potential test targets in a target's auto-generated scheme became more restrictive that previous versions. [#2796](https://github.com/tuist/tuist/pull/2796) by [@jakeatoms](https://github.com/jakeatoms)
