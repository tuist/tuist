...
- Add option to `Config.GenerationOptions` which allows to disable automatically running `pod install`.  [#3021](https://github.com/tuist/tuist/pull/3021) by [@svenmuennich](https://github.com/svenmuennich)
