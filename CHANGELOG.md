...
- **Breaking** remove `Config.GenerationOptions.disableAutogeneratedSchemes` helper
  - **Motivation**: it was redundant
  - **Migration**: use the `.autogeneratedSchemes(.disabled)` instead
- **Breaking** change default schemes generation to use `ProjectOption.AutomaticSchemesGrouping.byName` grouping
