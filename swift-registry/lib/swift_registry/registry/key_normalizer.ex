defmodule SwiftRegistry.Registry.KeyNormalizer do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> SwiftRegistry.Registry.KeyNormalizer.normalize_scope("Apple")
      "apple"

      iex> SwiftRegistry.Registry.KeyNormalizer.normalize_scope("SWIFT")
      "swift"
  """
  ...
  ## Examples
      ...
      iex> SwiftRegistry.Registry.KeyNormalizer.normalize_name("swift.argument.parser")
      "swift_argument_parser"

      iex> SwiftRegistry.Registry.KeyNormalizer.normalize_name("SwiftNIO")
      "swiftnio"
  """
  ...
  ## Examples
      ...
      iex> SwiftRegistry.Registry.KeyNormalizer.normalize_scope_name("Apple", "swift.argument.parser")
  ...
  ## Examples
      ...
      iex> SwiftRegistry.Registry.KeyNormalizer.normalize_version("v1.2.3")
      "1.2.3"

      iex> SwiftRegistry.Registry.KeyNormalizer.normalize_version("1")
      "1.0.0"

      iex> SwiftRegistry.Registry.KeyNormalizer.normalize_version("1.2")
      "1.2.0"
  ...
  ## Examples
      ...
      iex> SwiftRegistry.Registry.KeyNormalizer.package_object_key(%{scope: "Apple", name: "Parser"}, version: "v1.2", path: "source_archive.zip")
      "registry/swift/apple/parser/1.2.0/source_archive.zip"

      iex> SwiftRegistry.Registry.KeyNormalizer.package_object_key(%{scope: "swift", name: "nio"}, version: "2.0.0", path: "Package.swift")
      "registry/swift/swift/nio/2.0.0/Package.swift"

      iex> SwiftRegistry.Registry.KeyNormalizer.package_object_key(%{scope: "Apple", name: "Parser"}, [])
