defmodule SwiftRegistry.Registry.Disk do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> SwiftRegistry.Registry.Disk.key("Apple", "Parser", "v1.2", "source_archive.zip")
  ...
  ## Examples
      ...
      iex> SwiftRegistry.Registry.Disk.exists?("apple", "parser", "1.0.0", "source_archive.zip")
      true
  """
  ...
  ## Examples
     ...
     iex> SwiftRegistry.Registry.Disk.put("apple", "parser", "1.0.0", "source_archive.zip", <<1, 2, 3>>)
     :ok

      iex> SwiftRegistry.Registry.Disk.put("apple", "parser", "1.0.0", "source_archive.zip", {:file, "/tmp/upload"})
      :ok
  """
  ...
  ## Examples
      ...
      iex> SwiftRegistry.Registry.Disk.stat("apple", "parser", "1.0.0", "source_archive.zip")
  ...
  ## Examples
      ...
      iex> SwiftRegistry.Registry.Disk.local_accel_path("apple", "parser", "1.0.0", "source_archive.zip")
