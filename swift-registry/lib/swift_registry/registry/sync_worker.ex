defmodule SwiftRegistry.Registry.SyncWorker do
  @moduledoc """
  ...
  @github_opts [finch: SwiftRegistry.Finch, retry: false]
  ...
  defp registry_sync_allowlist do
    Application.get_env(:swift_registry, :registry_sync_allowlist)
  end

  defp registry_sync_limit do
    Application.get_env(:swift_registry, :registry_sync_limit)
  end
end
