defmodule SwiftRegistry.Finch.PromExPlugin do
  @moduledoc """
  ...
  alias SwiftRegistry.Finch.Pools
  ...
  def polling_metrics(opts) do
    ...
    Polling.build(
      :swift_registry_finch_pool_polling_metrics,
      poll_rate,
      {__MODULE__, :execute_pool_metrics, []},
      [
        last_value(
          [:swift_registry, :prom_ex, :finch, :pool, :available_connections],
          event_name: [:swift_registry, :prom_ex, :finch, :pool],
        ...
        last_value(
          [:swift_registry, :prom_ex, :finch, :pool, :in_use_connections],
          event_name: [:swift_registry, :prom_ex, :finch, :pool],
        ...
        last_value(
          [:swift_registry, :prom_ex, :finch, :pool, :size],
          event_name: [:swift_registry, :prom_ex, :finch, :pool],
  ...
  defp emit_pool_metrics(url) do
    case Finch.get_pool_status(SwiftRegistry.Finch, url) do
      {:ok, []} ->
        :ok
      ...
      {:ok, pools} ->
        ...
        :telemetry.execute(
          [:swift_registry, :prom_ex, :finch, :pool],
          totals,
          %{url: url}
        )
