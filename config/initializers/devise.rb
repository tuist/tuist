...
Devise.setup do |config|
  ...
  config.secret_key = Environment.secret_key_tokens
  ...
  config.mailer_sender = "noreply@cloud.tuist.io"
  ...
  config.pepper = Environment.secret_key_password
  ...
  config.warden do |manager|
    manager.before_failure do |env, opts|
      if env['PATH_INFO'].start_with?('/api')
        env['warden.options'][:action] = 'pass'
      end
    end
  end
