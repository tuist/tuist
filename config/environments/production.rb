...
Rails.application.configure do
  ...
  config.public_file_server.enabled = Environment.falsy?(ENV["RAILS_SERVE_STATIC_FILES"]) && Environment.self_hosted?
  ...
  # config.active_job.queue_name_prefix = "tuist_cloud_production"
