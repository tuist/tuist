defmodule Atlas.Ingestion.Bufferable do
  @moduledoc """
  Makes an Ecto schema bufferable for ClickHouse ingestion.

  Ported from Hive; see `Atlas.Ingestion.Buffer` for the flushing GenServer.
  """

  defmacro __using__(_opts) do
    quote do
      @before_compile Atlas.Ingestion.Bufferable
    end
  end
  ...
  defmacro __before_compile__(env) do
    ...
    quote do
      def buffer_opts do
        Atlas.Ingestion.Bufferable.compile_time_prepare(__MODULE__)
      end

      defmodule Buffer do
        @moduledoc false
        use Atlas.Ingestion.Bufferable.BufferImpl, parent: unquote(parent)
      end
    end
  end
