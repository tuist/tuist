...
class Invitation
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::Invitation).void)
      ).returns(T.nilable(T::Enumerator[::Invitation]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::Invitation]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::Invitation]]))
    end
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(::String) }
    def inviter_type; end

    sig { params(value: ::String).returns(::String) }
    def inviter_type=(value); end

    sig { returns(T::Boolean) }
    def inviter_type?; end

    sig { returns(T.nilable(::String)) }
    def inviter_type_before_last_save; end

    sig { returns(T.untyped) }
    def inviter_type_before_type_cast; end

    sig { returns(T::Boolean) }
    def inviter_type_came_from_user?; end

    sig { returns(T.nilable([::String, ::String])) }
    def inviter_type_change; end

    sig { returns(T.nilable([::String, ::String])) }
    def inviter_type_change_to_be_saved; end

    sig { params(from: ::String, to: ::String).returns(T::Boolean) }
    def inviter_type_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def inviter_type_in_database; end

    sig { returns(T.nilable([::String, ::String])) }
    def inviter_type_previous_change; end

    sig { params(from: ::String, to: ::String).returns(T::Boolean) }
    def inviter_type_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def inviter_type_previously_was; end

    sig { returns(T.nilable(::String)) }
    def inviter_type_was; end

    sig { void }
    def inviter_type_will_change!; end
    ...
    sig { returns(T.nilable([::String, ::String])) }
    def saved_change_to_inviter_type; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_inviter_type?; end
