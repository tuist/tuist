...
module Appsignal
  ...
  class << self
    ...
    # @since 0.2.7
    #
    # source://appsignal//lib/appsignal.rb#252
    def active?; end
    ...
    # @since 1.0.0
    #
    # source://appsignal//lib/appsignal.rb#223
    def extension_loaded?; end

    # source://appsignal//lib/appsignal.rb#153
    def forked; end

    # source://appsignal//lib/appsignal.rb#161
    ...
    # @return [StringIO]
    #
    # source://appsignal//lib/appsignal.rb#171
    def in_memory_log; end

    # @api private
    #
    # source://appsignal//lib/appsignal.rb#187
    ...
    # @see start_logger
    #
    # source://appsignal//lib/appsignal.rb#179
    def logger; end
    ...
    #
    # source://appsignal//lib/appsignal.rb#60
    ...
    # @since 0.7.0
    #
    # source://appsignal//lib/appsignal.rb#92
    def start; end
    ...
    # @since 0.7.0
    #
    # source://appsignal//lib/appsignal.rb#202
    ...
    # @since 1.0.0
    #
    # source://appsignal//lib/appsignal.rb#144
    def stop(called_by = T.unsafe(nil)); end

    # @api private
    # @return [Boolean]
    #
    # source://appsignal//lib/appsignal.rb#63
    def testing?; end

    private

    # source://appsignal//lib/appsignal.rb#272
    def collect_environment_metadata; end

    # source://appsignal//lib/appsignal.rb#263
    def start_file_logger(path); end

    # source://appsignal//lib/appsignal.rb#258
    def start_stdout_logger; end
  end
end
...
class Appsignal::Config
  ...
  # source://appsignal//lib/appsignal/config.rb#283
  def [](key); end

  # source://appsignal//lib/appsignal/config.rb#287
  def []=(key, value); end

  # @return [Boolean]
  #
  # source://appsignal//lib/appsignal/config.rb#322
  def active?; end
  ...
  # source://appsignal//lib/appsignal/config.rb#301
  def log_file_path; end

  # source://appsignal//lib/appsignal/config.rb#291
  def log_level; end
  ...
  # @return [Boolean]
  #
  # source://appsignal//lib/appsignal/config.rb#318
  def valid?; end

  # source://appsignal//lib/appsignal/config.rb#369
  def validate; end

  # source://appsignal//lib/appsignal/config.rb#326
  def write_to_environment; end

  private

  # source://appsignal//lib/appsignal/config.rb#392
  def config_file; end

  # source://appsignal//lib/appsignal/config.rb#397
  ...
  #
  # source://appsignal//lib/appsignal/config.rb#499
  ...
  #
  # source://appsignal//lib/appsignal/config.rb#453
  def maintain_backwards_compatibility; end

  # source://appsignal//lib/appsignal/config.rb#524
  ...
  class << self
    ...
    #
    # source://appsignal//lib/appsignal/config.rb#275
...
class Appsignal::Environment
  class << self
    ...
    # @api private
    #
    # source://appsignal//lib/appsignal/environment.rb#121
    ...
    # @api private
    #
    # source://appsignal//lib/appsignal/environment.rb#106
...
class Appsignal::Extension
  class << self
    ...
    def set_host_gauge(_arg0, _arg1); end
    def set_process_gauge(_arg0, _arg1); end
    def start; end
...
module Appsignal::Helpers::Metrics
  # source://appsignal//lib/appsignal/helpers/metrics.rb#42
  def add_distribution_value(key, value, tags = T.unsafe(nil)); end

  # source://appsignal//lib/appsignal/helpers/metrics.rb#31
  ...
  def set_host_gauge(key, value); end

  # source://appsignal//lib/appsignal/helpers/metrics.rb#24
  def set_process_gauge(key, value); end
end
...
class Appsignal::Hooks::RedisHook < ::Appsignal::Hooks::Hook
  ...
  # @api private
  #
  # source://appsignal//lib/appsignal/hooks/redis.rb#15
  def install; end
end
...
class Appsignal::Logger < ::Logger
  ...
  # @return [void]
  #
  # source://appsignal//lib/appsignal/logger.rb#25
  ...
  # @api private
  #
  # source://appsignal//lib/appsignal/logger.rb#37
  ...
  # @return [void]
  #
  # source://appsignal//lib/appsignal/logger.rb#68
  ...
  # @return [void]
  #
  # source://appsignal//lib/appsignal/logger.rb#107
  ...
  # @return [void]
  #
  # source://appsignal//lib/appsignal/logger.rb#120
  ...
  # @return [void]
  #
  # source://appsignal//lib/appsignal/logger.rb#81
  ...
  #
  # source://appsignal//lib/appsignal/logger.rb#138
  ...
  # @return [void]
  #
  # source://appsignal//lib/appsignal/logger.rb#94
  def warn(message = T.unsafe(nil), attributes = T.unsafe(nil)); end

  private

  # source://appsignal//lib/appsignal/logger.rb#144
  def add_with_attributes(severity, message, group, attributes); end

  # source://appsignal//lib/appsignal/logger.rb#151
...
class Appsignal::Probes::SidekiqProbe
  ...
  # source://appsignal//lib/appsignal/probes/sidekiq.rb#119
  def hostname; end
...
class Appsignal::Transaction
  ...
  #
  # source://appsignal//lib/appsignal/transaction.rb#90
  def initialize(transaction_id, namespace, request, options = T.unsafe(nil)); end

  # Returns the value of attribute action.
  #
  # source://appsignal//lib/appsignal/transaction.rb#75
  def action; end
  ...
  # @see https://docs.appsignal.com/ruby/instrumentation/breadcrumbs.html Breadcrumb reference
  #
  # source://appsignal//lib/appsignal/transaction.rb#188
  def add_breadcrumb(category, action, message = T.unsafe(nil), metadata = T.unsafe(nil), time = T.unsafe(nil)); end

  # source://appsignal//lib/appsignal/transaction.rb#362
  ...
  # source://appsignal//lib/appsignal/transaction.rb#114
  def complete; end

  # source://appsignal//lib/appsignal/transaction.rb#136
  def discard!; end
  ...
  # @return [Boolean]
  #
  # source://appsignal//lib/appsignal/transaction.rb#144
  def discarded?; end
  ...
  # source://appsignal//lib/appsignal/transaction.rb#386
  def finish_event(name, title, body, body_format = T.unsafe(nil)); end

  # source://appsignal//lib/appsignal/transaction.rb#411
  def instrument(name, title = T.unsafe(nil), body = T.unsafe(nil), body_format = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://appsignal//lib/appsignal/transaction.rb#110
  ...
  # @return [Hash]
  #
  # source://appsignal//lib/appsignal/transaction.rb#152
  def params; end
  ...
  #
  # source://appsignal//lib/appsignal/transaction.rb#88
  def params=(_arg0); end

  # source://appsignal//lib/appsignal/transaction.rb#124
  def pause!; end
  ...
  # @return [Boolean]
  #
  # source://appsignal//lib/appsignal/transaction.rb#132
  def paused?; end

  # source://appsignal//lib/appsignal/transaction.rb#398
  ...
  # source://appsignal//lib/appsignal/transaction.rb#140
  def restore!; end

  # source://appsignal//lib/appsignal/transaction.rb#128
  def resume!; end

  # source://appsignal//lib/appsignal/transaction.rb#349
  def sample_data; end
  ...
  # @since 2.2.0
  #
  # source://appsignal//lib/appsignal/transaction.rb#215
  def set_action(action); end
  ...
  # @since 2.2.0
  #
  # source://appsignal//lib/appsignal/transaction.rb#236
  def set_action_if_nil(action); end

  # source://appsignal//lib/appsignal/transaction.rb#362
  def set_error(error); end

  # source://appsignal//lib/appsignal/transaction.rb#264
  ...
  #
  # source://appsignal//lib/appsignal/transaction.rb#308
  def set_http_or_background_queue_start; end

  # source://appsignal//lib/appsignal/transaction.rb#315
  ...
  # @since 2.2.0
  #
  # source://appsignal//lib/appsignal/transaction.rb#257
  def set_namespace(namespace); end
  ...
  # @return [void]
  #
  # source://appsignal//lib/appsignal/transaction.rb#284
  def set_queue_start(start); end

  # source://appsignal//lib/appsignal/transaction.rb#322
  ...
  # @see https://docs.appsignal.com/ruby/instrumentation/tagging.html Tagging guide
  #
  # source://appsignal//lib/appsignal/transaction.rb#170
  def set_tags(given_tags = T.unsafe(nil)); end

  # source://appsignal//lib/appsignal/transaction.rb#380
  def start_event; end

  # source://appsignal//lib/appsignal/transaction.rb#148
  def store(key); end
  ...
  # @api private
  #
  # source://appsignal//lib/appsignal/transaction.rb#419
  def to_h; end
  ...
  #
  # source://appsignal//lib/appsignal/transaction.rb#444
  def background_queue_start; end

  # source://appsignal//lib/appsignal/transaction.rb#578
  ...
  #
  # source://appsignal//lib/appsignal/transaction.rb#588
  ...
  #
  # source://appsignal//lib/appsignal/transaction.rb#558
  def environment; end
  ...
  #
  # source://appsignal//lib/appsignal/transaction.rb#459
  def http_queue_start; end

  # source://appsignal//lib/appsignal/transaction.rb#489
  ...
  # @return [Hash<String, Object>]
  #
  # source://appsignal//lib/appsignal/transaction.rb#508
  ...
  # @return [Hash<String, Object>]
  #
  # source://appsignal//lib/appsignal/transaction.rb#543
  def sanitized_metadata; end

  # source://appsignal//lib/appsignal/transaction.rb#482
  ...
  # @return [Hash<String, Object>]
  #
  # source://appsignal//lib/appsignal/transaction.rb#527
  ...
  #
  # source://appsignal//lib/appsignal/transaction.rb#571
  ...
  class << self
    ...
    # @api private
    #
    # source://appsignal//lib/appsignal/transaction.rb#70
    def clear_current_transaction!; end

    # source://appsignal//lib/appsignal/transaction.rb#58
    def complete_current!; end

    # source://appsignal//lib/appsignal/transaction.rb#17
    ...
    # @see .current?
    #
    # source://appsignal//lib/appsignal/transaction.rb#45
    def current; end
    ...
    # @see .current
    #
    # source://appsignal//lib/appsignal/transaction.rb#54
    def current?; end
  end
end
...
# source://appsignal//lib/appsignal/transaction.rb#424
class Appsignal::Transaction::GenericRequest
  # @return [GenericRequest] a new instance of GenericRequest
  #
  # source://appsignal//lib/appsignal/transaction.rb#427
  def initialize(env); end

  # Returns the value of attribute env.
  #
  # source://appsignal//lib/appsignal/transaction.rb#425
  def env; end

  # source://appsignal//lib/appsignal/transaction.rb#431
  def params; end
end
...
# current transaction.
#
# source://appsignal//lib/appsignal/transaction.rb#600
class Appsignal::Transaction::NilTransaction
  # Instrument should still yield
  #
  # source://appsignal//lib/appsignal/transaction.rb#605
  def instrument(*_args); end

  # source://appsignal//lib/appsignal/transaction.rb#601
  def method_missing(_method, *args, &block); end

  # @return [Boolean]
  #
  # source://appsignal//lib/appsignal/transaction.rb#609
  def nil_transaction?; end
end
