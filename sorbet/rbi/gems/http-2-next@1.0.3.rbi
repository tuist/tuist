...
class HTTP2Next::Connection
  ...
  #
  # source://http-2-next//lib/http/2/next/connection.rb#78
  def initialize(settings = T.unsafe(nil)); end

  # source://http-2-next//lib/http/2/next/connection.rb#396
  def <<(data); end
  ...
  # @return [Boolean]
  #
  # source://http-2-next//lib/http/2/next/connection.rb#108
  def closed?; end
  ...
  #
  # source://http-2-next//lib/http/2/next/connection.rb#150
  ...
  #
  # source://http-2-next//lib/http/2/next/connection.rb#117
  ...
  #
  # source://http-2-next//lib/http/2/next/connection.rb#135
  ...
  #
  # source://http-2-next//lib/http/2/next/connection.rb#188
  ...
  #
  # source://http-2-next//lib/http/2/next/connection.rb#175
  ...
  #
  # source://http-2-next//lib/http/2/next/connection.rb#166
  ...
  #
  # source://http-2-next//lib/http/2/next/connection.rb#722
  ...
  # @raise []
  #
  # source://http-2-next//lib/http/2/next/connection.rb#783
  ...
  # @return [Boolean]
  #
  # source://http-2-next//lib/http/2/next/connection.rb#445
  ...
  # @param frame [Hash]
  #
  # source://http-2-next//lib/http/2/next/connection.rb#459
  ...
  # @param frame [Hash]
  #
  # source://http-2-next//lib/http/2/next/connection.rb#574
  ...
  # @param frame [Hash]
  #
  # source://http-2-next//lib/http/2/next/connection.rb#671
  ...
  #
  # source://http-2-next//lib/http/2/next/connection.rb#430
  ...
  #
  # source://http-2-next//lib/http/2/next/connection.rb#685
  ...
  # source://http-2-next//lib/http/2/next/connection.rb#794
  def manage_state(_); end

  # source://http-2-next//lib/http/2/next/connection.rb#511
  ...
  # @param frame [Hash]
  #
  # source://http-2-next//lib/http/2/next/connection.rb#408
  def send(frame); end
  ...
  #
  # source://http-2-next//lib/http/2/next/connection.rb#524
  def validate_settings(role, settings); end

  # source://http-2-next//lib/http/2/next/connection.rb#750
...
class HTTP2Next::Framer
  include ::HTTP2Next::Error
  include ::HTTP2Next::PackingExtensions

  # Initializes new framer object.
  #
  # @return [Framer] a new instance of Framer
  #
  # source://http-2-next//lib/http/2/next/framer.rb#117
  ...
  # @return [String]
  #
  # source://http-2-next//lib/http/2/next/framer.rb#129
  ...
  # maximum frame size
  #
  # source://http-2-next//lib/http/2/next/framer.rb#16
...
#
# source://http-2-next//lib/http/2/next/framer.rb#13
HTTP2Next::Framer::DEFAULT_MAX_FRAME_SIZE = T.let(T.unsafe(nil), Integer)

# Default error types as defined by the spec
#
# source://http-2-next//lib/http/2/next/framer.rb#86
HTTP2Next::Framer::DEFINED_ERRORS = T.let(T.unsafe(nil), Hash)

# Default settings as defined by the spec
#
# source://http-2-next//lib/http/2/next/framer.rb#76
...
#
# source://http-2-next//lib/http/2/next/framer.rb#43
...
# source://http-2-next//lib/http/2/next/framer.rb#111
HTTP2Next::Framer::FRAME_LENGTH_LOMASK = T.let(T.unsafe(nil), Integer)

# HTTP/2 frame type mapping as defined by the spec
#
# source://http-2-next//lib/http/2/next/framer.rb#25
HTTP2Next::Framer::FRAME_TYPES = T.let(T.unsafe(nil), Hash)

# source://http-2-next//lib/http/2/next/framer.rb#40
...
#
# source://http-2-next//lib/http/2/next/framer.rb#19
HTTP2Next::Framer::MAX_STREAM_ID = T.let(T.unsafe(nil), Integer)

# Maximum window increment value (2^31)
#
# source://http-2-next//lib/http/2/next/framer.rb#22
...
class HTTP2Next::Header::Compressor
  ...
  #
  # source://http-2-next//lib/http/2/next/header/compressor.rb#10
  ...
  #
  # source://http-2-next//lib/http/2/next/header/compressor.rb#37
  ...
  # @return [String] binary string
  #
  # source://http-2-next//lib/http/2/next/header/compressor.rb#74
  def string(str); end
  ...
  #
  # source://http-2-next//lib/http/2/next/header/compressor.rb#16
  ...
  # @return [String] binary string
  #
  # source://http-2-next//lib/http/2/next/header/compressor.rb#140
  def huffman_string(str); end

  # @param str [String]
  # @return [String] binary string
  #
  # source://http-2-next//lib/http/2/next/header/compressor.rb#149
  def plain_string(str); end
end
...
class HTTP2Next::Header::EncodingContext
  ...
  #
  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#104
  def initialize(options = T.unsafe(nil)); end
  ...
  # @return [Hash] command
  #
  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#248
  ...
  # @return [Integer]
  #
  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#293
  ...
  #
  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#139
  ...
  #
  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#118
  def dup; end
  ...
  #
  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#219
  def encode(headers); end

  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#297
  ...
  #   :index       Symbol   :all, :static, :never
  #
  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#95
  def options; end
  ...
  #
  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#153
  def process(cmd); end

  # Current table of header key-value pairs.
  #
  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#88
  def table; end

  # Alter dynamic table size.
  #  When the size is reduced, some headers might be evicted.
  #
  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#286
  def table_size=(size); end
  ...
  #
  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#310
  ...
  #
  # source://http-2-next//lib/http/2/next/header/encoding_context.rb#322
...
# @private
#
# source://http-2-next//lib/http/2/next/header/encoding_context.rb#16
HTTP2Next::Header::EncodingContext::STATIC_TABLE = T.let(T.unsafe(nil), Array)

# source://http-2-next//lib/http/2/next/header/encoding_context.rb#80
HTTP2Next::Header::EncodingContext::STATIC_TABLE_BY_FIELD = T.let(T.unsafe(nil), Hash)

# source://http-2-next//lib/http/2/next/header/encoding_context.rb#85
HTTP2Next::Header::EncodingContext::STATIC_TABLE_SIZE = T.let(T.unsafe(nil), Integer)

# source://http-2-next//lib/http/2/next/header/encoding_context.rb#11
...
class HTTP2Next::Header::Huffman
  ...
  # @return [String] binary string
  #
  # source://http-2-next//lib/http/2/next/header/huffman.rb#38
  def decode(buf); end
  ...
  # @return [String] binary string
  #
  # source://http-2-next//lib/http/2/next/header/huffman.rb#27
  def encode(str); end
end
...
#
# source://http-2-next//lib/http/2/next/header/huffman.rb#66
HTTP2Next::Header::Huffman::CODES = T.let(T.unsafe(nil), Array)

# source://http-2-next//lib/http/2/next/header/huffman.rb#326
HTTP2Next::Header::Huffman::ENCODE_TABLE = T.let(T.unsafe(nil), Array)

# source://http-2-next//lib/http/2/next/header/huffman.rb#19
...
#
# source://http-2-next//lib/http/2/next/extensions.rb#27
module HTTP2Next::PackingExtensions
  # source://http-2-next//lib/http/2/next/extensions.rb#41
...
#   end
#
# source://http-2-next//lib/http/2/next/server.rb#23
class HTTP2Next::Server < ::HTTP2Next::Connection
  # Initialize new HTTP 2.0 server object.
  #
  # @return [Server] a new instance of Server
  #
  # source://http-2-next//lib/http/2/next/server.rb#27
  def initialize(settings = T.unsafe(nil)); end
  ...
  # source://http-2-next//lib/http/2/next/server.rb#123
  ...
  #
  # source://http-2-next//lib/http/2/next/server.rb#72
  def upgrade(settings, headers, body); end

  private

  # source://http-2-next//lib/http/2/next/server.rb#130
  def connection_settings(frame); end
  ...
  # @yield [promise]
  #
  # source://http-2-next//lib/http/2/next/server.rb#147
  def promise(parent, headers, flags); end

  # source://http-2-next//lib/http/2/next/server.rb#137
  def verify_pseudo_headers(frame); end
end
...
class HTTP2Next::Stream
  ...
  # @param frame [Hash]
  #
  # source://http-2-next//lib/http/2/next/stream.rb#107
  def <<(frame); end

  # source://http-2-next//lib/http/2/next/stream.rb#180
  def calculate_content_length(data_length); end

  # Sends a RST_STREAM indicating that the stream is no longer needed.
  #
  # source://http-2-next//lib/http/2/next/stream.rb#285
  def cancel; end

  # Chunk data into max_size, yield each chunk, then return final chunk
  #
  # source://http-2-next//lib/http/2/next/stream.rb#266
  ...
  #
  # source://http-2-next//lib/http/2/next/stream.rb#280
  ...
  # @return [Boolean]
  #
  # source://http-2-next//lib/http/2/next/stream.rb#100
  def closed?; end
  ...
  #
  # source://http-2-next//lib/http/2/next/stream.rb#248
  ...
  #
  # source://http-2-next//lib/http/2/next/stream.rb#219
  ...
  # @raise [ArgumentError]
  #
  # source://http-2-next//lib/http/2/next/stream.rb#227
  ...
  #
  # source://http-2-next//lib/http/2/next/stream.rb#291
  def refuse; end
  ...
  #
  # source://http-2-next//lib/http/2/next/stream.rb#239
  ...
  # @param frame [Hash]
  #
  # source://http-2-next//lib/http/2/next/stream.rb#194
  def send(frame); end
  ...
  # source://http-2-next//lib/http/2/next/stream.rb#166
  ...
  # @param increment [Integer]
  #
  # source://http-2-next//lib/http/2/next/stream.rb#298
  def window_update(increment); end
  ...
  # permitted to open.
  #
  # source://http-2-next//lib/http/2/next/stream.rb#631
  def activate_stream_in_conn; end

  # source://http-2-next//lib/http/2/next/stream.rb#637
  def close_stream_in_conn(*args); end

  # source://http-2-next//lib/http/2/next/stream.rb#642
  def complete_transition(frame); end

  # @return [Boolean]
  #
  # source://http-2-next//lib/http/2/next/stream.rb#669
  def end_stream?(frame); end

  # @raise []
  #
  # source://http-2-next//lib/http/2/next/stream.rb#677
  def error(error = T.unsafe(nil), msg: T.unsafe(nil)); end

  # source://http-2-next//lib/http/2/next/stream.rb#605
  def event(newstate); end

  # source://http-2-next//lib/http/2/next/stream.rb#687
  def manage_state(frame); end

  # source://http-2-next//lib/http/2/next/stream.rb#653
  ...
  #                         +--------+
  #
  # source://http-2-next//lib/http/2/next/stream.rb#339
