...
class RBI::Tree < ::RBI::NodeWithComments
  # source://rbi/0.1.2/lib/rbi/model.rb#119
  sig do
    params(
  ...
  # source://rbi/0.1.2/lib/rbi/model.rb#126
  sig { params(node: ::RBI::Node).void }
  def <<(node); end

  # source://rbi/0.1.2/lib/rbi/printer.rb#226
  sig { override.params(v: ::RBI::Printer).void }
  def accept_printer(v); end

  # source://rbi/0.1.2/lib/rbi/rewriters/add_sig_templates.rb#66
  sig { params(with_todo_comment: T::Boolean).void }
  def add_sig_templates!(with_todo_comment: T.unsafe(nil)); end

  # source://rbi/0.1.2/lib/rbi/rewriters/annotate.rb#49
  ...
  # source://rbi/0.1.2/lib/rbi/rewriters/deannotate.rb#41
  sig { params(annotation: ::String).void }
  def deannotate!(annotation); end

  # source://rbi/0.1.2/lib/rbi/model.rb#132
  sig { returns(T::Boolean) }
  def empty?; end

  # source://rbi/0.1.2/lib/rbi/rewriters/group_nodes.rb#38
  sig { void }
  def group_nodes!; end

  # source://rbi/0.1.2/lib/rbi/index.rb#68
  sig { returns(::RBI::Index) }
  def index; end

  # source://rbi/0.1.2/lib/rbi/rewriters/merge_trees.rb#324
  sig do
    params(
      other: ::RBI::Tree,
      left_name: ::String,
  ...
  # source://rbi/0.1.2/lib/rbi/rewriters/nest_non_public_methods.rb#46
  sig { void }
  def nest_non_public_methods!; end

  # source://rbi/0.1.2/lib/rbi/rewriters/nest_singleton_methods.rb#36
  sig { void }
  def nest_singleton_methods!; end

  # source://rbi/0.1.2/lib/rbi/model.rb#110
  sig { returns(T::Array[::RBI::Node]) }
  def nodes; end

  # source://rbi/0.1.2/lib/rbi/printer.rb#233
  sig { override.returns(T::Boolean) }
  def oneline?; end

  # source://rbi/0.1.2/lib/rbi/rewriters/sort_nodes.rb#119
  sig { void }
  def sort_nodes!; end
