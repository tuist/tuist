defmodule Tuist.Registry.Swift.Lock do
  @moduledoc """
  S3-backed distributed lock used by sync workers to coordinate across
  pods (and across the transitional period when cache's SyncWorker still
  ...
  defp bucket, do: Registry.registry_bucket()
