defmodule Tuist.Runners.Buildkite do
  ...
  defdelegate log_window_open?(workflow_job_id, grace_seconds), to: JobReports
  defdelegate runner_name_for_job(workflow_job_id, account_id), to: JobReports
  defdelegate record_job_finished(runner_name, account_id, report), to: JobReports
  defdelegate conclusion_for(report), to: JobReports
