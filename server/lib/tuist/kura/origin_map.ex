defmodule Tuist.Kura.OriginMap do
  ...
  @zone_preferences %{
    us_east: ["us-east", "ca-east", "us-west", "eu-west", "sa-west", "ap-southeast"],
    us_west: ["us-west", "us-east", "ca-east", "sa-west", "ap-southeast", "eu-west"],
    canada_east: ["ca-east", "us-east", "us-west", "eu-west", "sa-west", "ap-southeast"],
    europe: ["eu-west", "us-east", "ca-east", "us-west", "ap-southeast", "sa-west"],
    apac: ["ap-southeast", "us-west", "us-east", "eu-west", "ca-east", "sa-west"],
    south_america: ["sa-west", "us-east", "ca-east", "us-west", "eu-west", "ap-southeast"],
    africa_middle_east: [
      "eu-west",
      "us-east",
      "ca-east",
