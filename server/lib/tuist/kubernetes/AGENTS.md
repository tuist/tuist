...
- Keep kubeconfig-backed helpers scoped to explicit local-controller/dev use. Production code for the server's own cluster should use the in-cluster client path.
