defmodule Tuist.QA.Run do
  ...
  @type t :: %__MODULE__{
          id: binary(),
          app_build_id: binary(),
          app_build: AppBuild.t() | Ecto.Association.NotLoaded.t(),
          prompt: String.t(),
          status: String.t(),
          run_steps: [RunStep.t()] | Ecto.Association.NotLoaded.t(),
  ...
  @doc false
  def changeset(qa_run, attrs) do
    qa_run
    |> cast(attrs, [:app_build_id, :prompt, :status])
