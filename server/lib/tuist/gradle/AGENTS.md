...
- `ExecutionGraph` models dependencies and hard ordering; soft ordering is not a hard edge. Reachability uses data dependencies only. Missing timings and partial/cyclic graphs never produce a numeric chain estimate.
