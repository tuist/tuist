defmodule Tuist.OAuth.Clients do
  ...
  if Mix.env() == :dev do
    ...
    defp dev_default(:client_id), do: "5339abf2-467c-4690-b816-17246ed149d2"
    defp dev_default(:client_secret), do: "dev-secret"
    defp dev_default(:client_name), do: "Tuist Dev"

    defp dev_default(:private_key),
      do:
        String.trim("""
        -----BEGIN PRIVATE KEY-----
