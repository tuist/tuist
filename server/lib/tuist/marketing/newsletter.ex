defmodule Tuist.Marketing.Newsletter do
  ...
  use Tuist.Marketing.NimblePublisher.Content,
    ...
    dev_from: Path.expand("../../../priv/marketing/newsletter/issues/*.yml", __DIR__),
    prod_from: Application.app_dir(:tuist, "priv/marketing/newsletter/issues/*.yml"),
    as: :issues,
    parser: Tuist.Marketing.Newsletter.IssueParser,
    highlighters: []

  def issues, do: content_entries()
