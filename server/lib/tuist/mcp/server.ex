defmodule Tuist.MCP.Server do
  ...
  @tools [
    ...
    Tools.GetTestRun,
    Tools.GetTestRunCoverage,
    Tools.ListTestRunCoverageFiles,
    Tools.GetTestRunCoverageEvidence,
    Tools.ListTestCoverageEvidenceFiles,
    Tools.ListTestsCoveringFile,
    Tools.GetTestRunCoverageFile,
    Tools.GetTestRunCoverageComparison,
