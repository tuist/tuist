defmodule Tuist.CommandEvents.Event do
  ...
  @sensitive_environment_variable_name_components ~w(
    CREDENTIAL CREDENTIALS DSN DSNS KEY KEYS LICENSE PASSPHRASE PASSPHRASES PASSWORD PASSWORDS SECRET SECRETS TOKEN TOKENS URL URLS
  )
  ...
  schema "command_events" do
    ...
    field :environment, Ch, type: "Map(String, String)", default: %{}, load_in_query: false
