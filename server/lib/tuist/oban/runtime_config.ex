defmodule Tuist.Oban.RuntimeConfig do
  ...
  @hosted_only_crons [
    ...
    # claim the mirror is" rather than throughput pressure. 6h
    # lands us within half a working day of an Apple release on
    # average.
    {"0 */6 * * *", Tuist.XcodeMirror.Workers.ReconcileWorker}
  ]
