      ...
      <.card title={dgettext("dashboard_projects", "Bazel remote cache")} icon="server">
        ...
        <.card_section data-part="bazel-remote-cache">
          <span data-part="description">
            {dgettext(
              "dashboard_projects",
              "Set up this project's remote cache from the root of your Bazel repository. The first request appears here after Kura observes it."
            )}
          </span>
          <.terminal id="bazel-setup" command="tuist bazel setup" />
        </.card_section>
      </.card>
    </div>
    """
