...
- GitLab CI connections in Integrations bind a runner token to one profile. Never repopulate token inputs; job detail views load account-scoped metadata without execution payloads.
