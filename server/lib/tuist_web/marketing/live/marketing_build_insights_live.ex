defmodule TuistWeb.Marketing.MarketingBuildInsightsLive do
  ...
  def mount(_params, session, socket) do
    ...
    socket =
      ...
      |> assign(:builds_last_24h, stats.builds_last_24h)
    ...
    {:noreply,
     ...
     |> assign(
       ...
       Tuist.Environment.app_url(
         path: TuistWeb.Helpers.OpenGraph.marketing_og_image_path("/marketing/images/og/generated/build-insights.jpg")
       )
     )
     |> assign(
       :head_description,
  ...
  def handle_info({:marketing_stats_updated, stats}, socket) do
    {:noreply, assign(socket, :builds_last_24h, stats.builds_last_24h)}
  end
end
