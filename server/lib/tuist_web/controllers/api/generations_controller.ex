defmodule TuistWeb.API.GenerationsController do
  ...
  operation(:index,
    summary: "List generations for a project.",
    ...
    parameters: [
      ...
      git_ref: [
        in: :query,
        type: :string,
        description: "The git ref of the generation."
      ],
      git_branch: [
        in: :query,
        type: :string,
        description: "The git branch of the generation."
      ],
      git_commit_sha: [
        in: :query,
        type: :string,
        description: "The git commit SHA of the generation."
      ],
      page_size: [
        in: :query,
        type: %Schema{
  ...
  operation(:show,
    ...
    responses: %{
      ok: {"Generation details", "application/json", Run},
      unauthorized: {"You need to be authenticated to access this resource", "application/json", Error},
  ...
  def show(%{assigns: %{selected_project: selected_project}} = conn, params) do
    ...
    with {:ok, command_event} <- CommandEvents.get_command_event_by_id(run_id),
         ...
         true <- command_event.name == "generate" do
