...
- Runner sizing coverage must include runner-only accounts in claim proposals, account-sized claims on creation, preserved legacy claims on enrollment, and manifests that apply memory profiles without requesting an unadvertised memory-ceiling resource.
