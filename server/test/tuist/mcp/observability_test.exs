defmodule Tuist.MCP.ObservabilityTest do
  ...
  test "records the authorized target account and project" do
    ...
    assert_receive {:trace_attribute, "mcp_account_handle", "tuist"}
    assert_receive {:trace_attribute, "mcp_project_handle", "atlas"}
  end

  test "records the tool name" do
    expect(OpenTelemetry.Tracer, :set_attribute, fn "mcp_tool_name", "list_projects" ->
      :ok
    end)
