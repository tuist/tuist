...
Mimic.copy(Tuist.XcodeMirror)
Mimic.copy(Tuist.XcodeMirror.AppleReleases)
Mimic.copy(Tuist.XcodeMirror.Registry)
Mimic.copy(Tuist.XcodeMirror.Downloader)
Mimic.copy(Tuist.XcodeMirror.Pusher)
