...
Mimic.copy(Tuist.Automations.Actions.MarkAsFlakyAction)
Mimic.copy(Tuist.Automations.Actions.UnmarkAsFlakyAction)
Mimic.copy(Tuist.Automations.Types.FlakinessRateType)
