...
Mimic.copy(Runner.Runner.GitHub.Auth)
Mimic.copy(Runner.Runner.GitHub.Registration)
Mimic.copy(Runner.Runner.GitHub.Session)
Mimic.copy(Runner.Runner.GitHub.MessageListener)
Mimic.copy(Runner.Runner.GitHub.JobRunner)
Mimic.copy(Runner.Runner.JobExecutor)
Mimic.copy(Runner.Runner.Connection)
