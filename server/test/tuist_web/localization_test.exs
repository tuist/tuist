defmodule TuistWeb.Marketing.LocalizationTest do
  ...
  #   test "localizes tuist.dev docs URLs with current locale" do
  #     # Given
  ...
  #   test "replaces existing locale in tuist.dev docs URLs" do
  #     # Given
  ...
  #   test "handles tuist.dev docs URLs with English locale" do
  #     # Given
  #     Gettext.put_locale(TuistWeb.Gettext, "ko")
  ...
  #   test "handles tuist.dev docs root path" do
  #     # Given
  #     Gettext.put_locale(TuistWeb.Gettext, "ja")
  ...
  describe "docs URL localization" do
    test "places the locale before the docs path" do
      Gettext.put_locale(TuistWeb.Gettext, "ko")
    ...
    test "normalizes locale-prefixed docs URLs" do
      result =
