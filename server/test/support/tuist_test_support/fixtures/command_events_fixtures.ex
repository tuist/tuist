  ...
  def command_event_fixture(attrs \\ []) do
    ...
    CommandEvents.create_command_event(
      %{
        ...
        remote_cache_target_hits_count: attrs |> Keyword.get(:remote_cache_target_hits, []) |> length(),
        ...
        remote_test_target_hits_count: attrs |> Keyword.get(:remote_test_target_hits, []) |> length(),
