defmodule TuistTestSupport.Utilities do
  ...
  def truncate_clickhouse_tables do
    commands = [
      ...
      "TRUNCATE TABLE IF EXISTS test_case_failures",
      "TRUNCATE TABLE IF EXISTS test_case_run_attachments",
      "TRUNCATE TABLE IF EXISTS test_case_run_repetitions",
      "TRUNCATE TABLE IF EXISTS test_cases",
      "TRUNCATE TABLE IF EXISTS test_module_runs",
      "TRUNCATE TABLE IF EXISTS test_suite_runs",
      "TRUNCATE TABLE IF EXISTS test_case_events",
