defmodule Tuist.MixProject do
  ...
  defp deps do
    [
      ...
      {:bandit,
       git: "https://github.com/tuist/bandit",
       branch: "detect-client-disconnect-on-timeout",
       override: true},
      ...
      {:ch,
       git: "https://github.com/tuist/ch.git",
       branch: "codex/experimental-transactions",
       override: true},
      {:ecto_ch,
       git: "https://github.com/tuist/ecto_ch.git",
       branch: "codex/experimental-transactions",
       override: true},
      {:noora, path: "../noora"},
      {:zstream, "~> 0.6"},
