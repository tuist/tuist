...
- Local development uses a clone-local persisted suffix in `.tuist-dev-instance` via mise shell env to scope service ports, MinIO ports, and dev database names.
