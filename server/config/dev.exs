...
alias Tuist.Config.DevInstance

Code.require_file("dev_instance.exs", __DIR__)

dev_database = DevInstance.database_name("tuist_development")
dev_port = DevInstance.port(8080)
dev_app_url = DevInstance.app_url()
