defmodule Tuist.Repo.Migrations.CreateRunnerCacheVolumeMeasurements do
  ...
  def change do
    create table(:runner_cache_volume_measurements) do
      add(:usage_id, references(:runner_cache_volume_uses, type: :uuid, on_delete: :delete_all), null: false)
    ...
    create(index(:runner_cache_volume_measurements, [:usage_id, :observed_at]))
  end
end
