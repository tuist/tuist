...
{:ok, tuist_project} =
  Projects.update_project(tuist_project, %{
    ...
    # The pull request's head was measured by a partial run (selective testing
    # left tests out), and its patch is worth reading anyway.
    coverage_patch_partial_runs: true,
