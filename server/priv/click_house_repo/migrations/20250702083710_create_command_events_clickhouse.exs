      ...
      execute """
       ...
       (
           ...
           `remote_cache_target_hits` Array(String),
            `is_ci` Nullable(Bool) DEFAULT false,           `test_targets` Array(String),
           ...
           `user_id` Nullable(Int32),
            ...
            `remote_test_target_hits_count` Nullable(Int32) DEFAULT 0,           `git_commit_sha` Nullable(String),
           `git_ref` Nullable(String),
           `preview_id` UUID,
           `git_branch` Nullable(String),
            `ran_at` Nullable(DateTime64(6)),           `build_run_id` UUID,
