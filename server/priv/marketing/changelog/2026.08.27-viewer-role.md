...
Pick the role when you invite someone from **Members**, or change an existing member's from the same page. Organizations using single sign-on can also choose which role automatic enrollment and SCIM provisioning grant.
