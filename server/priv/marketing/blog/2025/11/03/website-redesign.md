...
The first thing we noticed was that our story wasn’t being told the way we wanted it to be. Tuist had grown far beyond being just a CLI tool, yet our website still gave that impression. We wanted to communicate what Tuist truly is today, a platform that helps teams build, collaborate, and ship iOS apps faster.
...
Another issue we saw was how difficult it was to find information or understand what Tuist offered at a glance. The navigation felt fragmented and didn’t guide new visitors through the story.
