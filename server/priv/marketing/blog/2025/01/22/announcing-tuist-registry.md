...
To start using the registry, first [install Tuist](https://tuist.dev/en/docs/guides/quick-start/install-tuist#install-tuist). Then you need to have a [Tuist Project](https://tuist.dev/en/docs/server/introduction/accounts-and-projects). You can create one by running:
