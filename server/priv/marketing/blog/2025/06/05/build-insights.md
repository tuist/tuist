...
To get started with build insights, you will need a [Tuist account and a project](https://tuist.dev/en/docs/server/introduction/accounts-and-projects). The best way to get started is to use our [CLI](https://tuist.dev/en/docs/guides/quick-start/install-tuist) and run the `tuist init` command.
