...
excerpt: "We built an LLM-powered localization system that keeps translations in the repository, making changes easier to validate and the repo the source of truth."
author: pepicrft
