...
For detailed setup instructions, including configuration options and on-premise installation, see the [Slack integration documentation](https://tuist.dev/en/docs/guides/integrations/slack).
