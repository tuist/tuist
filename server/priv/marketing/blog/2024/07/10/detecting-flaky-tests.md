...
We believe this is a crucial feature for any team that wants to ship reliable software. If you want to try it [create an account](https://tuist.dev/en/docs/guides/server/accounts-and-projects) and run `tuist test` in your project. We welcome your feedback and look forward to hearing from you.
