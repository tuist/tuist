defmodule Tuist.IngestRepo.Migrations.AddProjectRanAtProjectionToTestCaseRuns do
  @moduledoc """
  Adds a new `proj_test_case_runs_by_project_ran_at` projection that includes all
  columns, ordered by `(project_id, ran_at)`.
  ...
  The old projection is dropped in a separate migration after materialization completes
  to avoid conflicts with pending mutations.
  """
  use Ecto.Migration
