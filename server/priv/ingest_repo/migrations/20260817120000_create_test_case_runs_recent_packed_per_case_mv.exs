defmodule Tuist.IngestRepo.Migrations.CreateTestCaseRunsRecentPackedPerCaseMv do
  @moduledoc """
  ...
  def up do
    ...
    IngestRepo.query!("DROP VIEW IF EXISTS test_case_runs_recent_packed_per_case_mv")

    # excellent_migrations:safety-assured-for-next-line raw_sql_executed
    IngestRepo.query!("""
    CREATE TABLE IF NOT EXISTS test_case_runs_recent_packed_per_case (
      project_id Int64,
      test_case_id UUID,
    ...
    # excellent_migrations:safety-assured-for-next-line raw_sql_executed
    IngestRepo.query!("""
    CREATE MATERIALIZED VIEW IF NOT EXISTS test_case_runs_recent_packed_per_case_mv
    TO test_case_runs_recent_packed_per_case
    AS SELECT
      project_id,
  ...
  def down do
    ...
    # excellent_migrations:safety-assured-for-next-line raw_sql_executed
    IngestRepo.query!("DROP TABLE IF EXISTS test_case_runs_recent_packed_per_case")
  end
end
