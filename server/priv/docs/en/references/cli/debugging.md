...
> [!TIP]
> Learn more about Tuist's directory organization and how to configure custom directories in the <.localized_link href="/references/cli/directories">Directories documentation</.localized_link>.
