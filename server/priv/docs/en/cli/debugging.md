...
> [!TIP]
> Learn more about Tuist's directory organization and how to configure custom directories in the <TuistWeb.Docs.MarkdownComponents.localized_link href="/cli/directories">Directories documentation</TuistWeb.Docs.MarkdownComponents.localized_link>.
