...
| `list_gradle_build_tasks` | List task outcomes, composite build identity, cacheability, incremental status, and observed remote operation timings. | `build_run_id` |
