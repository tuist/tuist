...
Additionally, when calculating the hash for <.localized_link href="/guides/features/cache">caching</.localized_link>, we also hash the following attributes.
...
1. Run `tuist hash cache` or `tuist hash selective-testing` (hashes for <.localized_link href="/guides/features/cache">binary caching</.localized_link> or <.localized_link href="/guides/features/selective-testing">selective testing</.localized_link>), copy the hashes, rename the project directory, and run the command again. The hashes should match.
