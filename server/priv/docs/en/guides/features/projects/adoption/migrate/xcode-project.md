...
Unless you <.localized_link href="/guides/features/projects/adoption/new-project">create a new project using Tuist</.localized_link>, in which case you get everything configured automatically, you'll have to define your Xcode projects using Tuist's primitives. How tedious this process is, depends on how complex your projects are.
