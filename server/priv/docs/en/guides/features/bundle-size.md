...
To track bundle size over time, you will need to analyze the bundle on the CI. First, you will need to ensure that your CI is <TuistWeb.Docs.MarkdownComponents.localized_link href="/guides/integrations/continuous-integration#authentication">authenticated</TuistWeb.Docs.MarkdownComponents.localized_link>:
