...
2. Follow the <.localized_link href="/guides/features/runners/ci-providers/github-actions">GitHub Actions runner guide</.localized_link> to connect the project to its GitHub organization.
