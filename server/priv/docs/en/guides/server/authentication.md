...
1. **Connect your repository to Tuist**: Follow the <TuistWeb.Docs.MarkdownComponents.localized_link href="/guides/integrations/gitforge/github">GitHub integration guide</TuistWeb.Docs.MarkdownComponents.localized_link> to connect your GitHub repository to your Tuist project.
...
See the <TuistWeb.Docs.MarkdownComponents.localized_link href="/guides/integrations/continuous-integration">Continuous Integration guide</TuistWeb.Docs.MarkdownComponents.localized_link> for provider-specific configuration examples.
...
For project and server configuration, including `project` and `url`, use the canonical <TuistWeb.Docs.MarkdownComponents.localized_link href="/references/tuist-toml">tuist.toml reference</TuistWeb.Docs.MarkdownComponents.localized_link>.
...
- <TuistWeb.Docs.MarkdownComponents.localized_link href="/guides/server/authentication#setting-up-oidc-authentication">OIDC authentication</TuistWeb.Docs.MarkdownComponents.localized_link> (recommended when available)
- <TuistWeb.Docs.MarkdownComponents.localized_link href="/guides/server/authentication#continuous-integration">Account token authentication</TuistWeb.Docs.MarkdownComponents.localized_link> via `TUIST_TOKEN`
