...
| Gradle build records, task records, cache event records, Bazel invocations, pending Bazel test ingestion records, Bazel invocation logs, and Bazel remote action-cache observations | 90 days |
