...
| Gradle build records, task records, cache event records, Bazel invocations, Bazel trace profiles and action diagnostics, pending Bazel test ingestion records, Bazel invocation logs, and Bazel remote action-cache observations | 90 days |
