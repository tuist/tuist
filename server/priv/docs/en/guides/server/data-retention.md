...
| Gradle build records, task records, cache event records, Bazel invocations, Bazel test results, Bazel invocation logs, and Bazel remote action-cache observations | 90 days |
