...
(/images/guides/features/build-insights/builds-dashboard.png)
...
![الإجراء اللاحق لفحص
الاختبارات](/images/guides/features/build-insights/inspect-test-scheme-post-action.png)
...
(/images/guides/features/build-insights/tests-dashboard.png)
...
![تفاصيل الاختبار] (/images/guides/features/build-insights/test-detail.png)
