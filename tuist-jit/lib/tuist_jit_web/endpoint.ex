defmodule TuistJitWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :tuist_jit
  ...
  plug Plug.Parsers,
    ...
    body_reader: {TuistJitWeb.Plugs.CachingBodyReader, :read_body, []}

  plug Plug.MethodOverride
  plug Plug.Head
  plug TuistJitWeb.Router
end
