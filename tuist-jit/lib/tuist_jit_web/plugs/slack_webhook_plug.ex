defmodule TuistJitWeb.Plugs.SlackWebhookPlug do
  @moduledoc """
  ...
  Wired into the slack-webhook pipeline in `TuistJitWeb.Router`.
  Pulls the signing secret from `TuistJit.Environment` at call time
