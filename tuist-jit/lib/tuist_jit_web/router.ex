defmodule TuistJitWeb.Router do
  use TuistJitWeb, :router

  pipeline :slack_webhook do
    plug :accepts, ["json"]
    plug TuistJitWeb.Plugs.SlackWebhookPlug
  end
  ...
  scope "/webhooks/slack", TuistJitWeb do
