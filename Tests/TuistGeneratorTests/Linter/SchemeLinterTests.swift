        ...
        let project = Project.test(schemes: [
            .init(
                ...
                buildAction: .init(targets: [
                    .init(projectPath: AbsolutePath("/Project"), name: "Target")
                ])
            )
        ])
    ...
    func test_lint_referenceRemoteTargetBuildAction() {
        ...
        let project = Project.test(schemes: [
            .init(
                ...
                shared: true,
                buildAction: .init(targets: [
                    .init(projectPath: AbsolutePath("/Project/../Framework"), name: "Framework")
                ])
            )
        ])
                ...
                .init(
                    ...
                    testAction: .init(
                        targets: [
                            .init(
                                target: .init(
                                    projectPath: AbsolutePath("/Project/../Framework"),
                                    name: "Framework"
                                )
                            )
                        ],
        ...
        let project = Project.test(
            ...
            schemes: [
                .init(
                    ...
                    runAction: .test(
                        options: .init(
                            storeKitConfigurationPath: "/non/existing/path/configuration.storekit"
                        )
                    )
                )
            ]
