...
final class AutogeneratedWorkspaceSchemeWorkspaceMapperTests: TuistUnitTestCase {
    func test_map() throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeWorkspaceMapper(codeCoverageMode: nil, testingOptions: [])
    ...
    func test_map_testing_options_single_value() throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeWorkspaceMapper(codeCoverageMode: nil, testingOptions: [.parallelizable])
        let targetA = Target.test(
            name: "A"
        )
        let targetATests = Target.test(
