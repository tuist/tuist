...
final class AutogeneratedProjectSchemeWorkspaceMapperTests: TuistUnitTestCase {
    func test_map() throws {
        // Given
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: nil, testingOptions: nil)
    ...
    func test_multiple_project_sorting() throws {
        // Given
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: .all, testingOptions: nil)
    ...
    func test_map_codeCoverageMode_targets() throws {
        ...
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: .targets([targetBRef]), testingOptions: nil)
    ...
    func test_map_codeCoverageMode_relevant_nonEmpty() throws {
        ...
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: .relevant, testingOptions: nil)
    ...
    func test_map_testing_options_all() throws {
        // Given
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: nil, testingOptions: [.parallelizable, .randomExecutionOrdering])
        let targetA = Target.test(
            name: "A"
        )
        let targetATests = Target.test(
    ...
    func test_map_testing_options_single_value() throws {
        // Given
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: nil, testingOptions: [.parallelizable])
        let targetA = Target.test(
            name: "A"
        )
        let targetATests = Target.test(
    ...
    func test_map_testing_options_empty() throws {
        // Given
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: nil, testingOptions: [])
        let targetA = Target.test(
            name: "A"
        )
        let targetATests = Target.test(
