...
final class AutogeneratedProjectSchemeWorkspaceMapperTests: TuistUnitTestCase {
    func test_map() throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeWorkspaceMapper(codeCoverageMode: .disabled, testingOptions: [])
    ...
    func test_multiple_project_sorting() throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeWorkspaceMapper(codeCoverageMode: .all, testingOptions: [])
    ...
    func test_map_codeCoverageMode_targets() throws {
        ...
        let subject = AutogeneratedWorkspaceSchemeWorkspaceMapper(codeCoverageMode: .targets([targetBRef]), testingOptions: [])
    ...
    func test_map_codeCoverageMode_relevant_nonEmpty() throws {
        ...
        let subject = AutogeneratedWorkspaceSchemeWorkspaceMapper(codeCoverageMode: .relevant, testingOptions: [])
    ...
    func test_map_testing_options_all() throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeWorkspaceMapper(
    ...
    func test_map_testing_options_single_value() throws {
        // Given
        let subject = AutogeneratedWorkspaceSchemeWorkspaceMapper(codeCoverageMode: .disabled, testingOptions: [.parallelizable])
        let targetA = Target.test(
            name: "A"
        )
        let targetATests = Target.test(
