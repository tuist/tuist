...
final class AutogeneratedProjectSchemeWorkspaceMapperTests: TuistUnitTestCase {
    func test_map() throws {
        // Given
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: nil, autogenerationOptions: nil)
    ...
    func test_multiple_project_sorting() throws {
        // Given
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: .all, autogenerationOptions: nil)
    ...
    func test_map_codeCoverageMode_targets() throws {
        ...
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: .targets([targetBRef]), autogenerationOptions: nil)
    ...
    func test_map_codeCoverageMode_relevant_nonEmpty() throws {
        ...
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: .relevant, autogenerationOptions: nil)
    ...
    func test_map_testing_options_all() throws {
        // Given
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: nil, autogenerationOptions: .enabled([.parallelizable, .randomExecutionOrdering]))
        let targetA = Target.test(
            name: "A"
        )
        let targetATests = Target.test(
    ...
    func test_map_testing_options_single_value() throws {
        // Given
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: nil, autogenerationOptions: .enabled([.parallelizable]))
        let targetA = Target.test(
            name: "A"
        )
        let targetATests = Target.test(
    ...
    func test_map_testing_options_empty() throws {
        // Given
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: nil, autogenerationOptions: .enabled([]))
        let targetA = Target.test(
            name: "A"
        )
        let targetATests = Target.test(
