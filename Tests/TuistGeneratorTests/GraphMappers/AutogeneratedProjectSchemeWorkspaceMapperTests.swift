...
final class AutogeneratedProjectSchemeWorkspaceMapperTests: TuistUnitTestCase {
    ...
    func test_multiple_project_sorting() throws {
        // Given
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: .all, testingOptions: [])
    ...
    func test_map_codeCoverageMode_targets() throws {
        ...
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: .targets([targetBRef]), testingOptions: [])
    ...
    func test_map_codeCoverageMode_relevant_nonEmpty() throws {
        ...
        let subject = AutogeneratedProjectSchemeWorkspaceMapper(codeCoverageMode: .relevant, testingOptions: [])
