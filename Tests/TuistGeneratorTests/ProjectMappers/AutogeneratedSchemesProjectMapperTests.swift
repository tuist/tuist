...
final class AutogeneratedSchemesProjectMapperTests: TuistUnitTestCase {
    ...
    func test_grouping_singleScheme() throws {
        ...
        let expected = [
            makeScheme(
                name: "Project",
                buildTargetNames: ["A", "ATests", "BIntegrationTests", "BSnapshotTests", "BTests", "BUITests", "ADemo", "B"],
    ...
    func test_grouping_byNameSuffix() throws {
        ...
        let expected = [
            makeScheme(
                name: "A",
                buildTargetNames: ["A", "ATests", "ADemo"],
            ...
            makeScheme(
                name: "B",
                buildTargetNames: ["BIntegrationTests", "BSnapshotTests", "BTests", "BUITests", "B"],
