...
extension TuistTestCase {
    ...
    func assert(
        ...
        XCTAssertTrue(
            testAction.configurationName == manifest.configuration.rawValue,
            file: file,
            line: line
        )
    ...
    func assert(
        ...
        XCTAssertTrue(
            runAction.configurationName == manifest.configuration.rawValue,
            file: file,
            line: line
        )
    ...
    fileprivate func optionalAssert<A, B>(
        _ optionalA: A?,
        _ optionalB: B?,
        file: StaticString = #file,
        line: UInt = #line,
