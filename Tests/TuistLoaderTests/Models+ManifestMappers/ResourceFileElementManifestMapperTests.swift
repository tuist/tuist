...
final class ResourceFileElementManifestMapperTests: TuistUnitTestCase {
    func test_from_outputs_a_warning_when_the_paths_point_to_directories() throws {
        ...
        // When
        let model = try XcodeProjectGenerator.ResourceFileElement.from(
            manifest: manifest,
    ...
    func test_from_outputs_a_warning_when_the_folder_reference_is_invalid() throws {
        ...
        // When
        let model = try XcodeProjectGenerator.ResourceFileElement.from(manifest: manifest, generatorPaths: generatorPaths)
    ...
    func test_throws_when_the_glob_is_invalid() throws {
        ...
        XCTAssertThrowsSpecific(
            try XcodeProjectGenerator.ResourceFileElement.from(manifest: manifest, generatorPaths: generatorPaths),
            error
        )
    }
