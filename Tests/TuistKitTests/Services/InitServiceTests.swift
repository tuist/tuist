...
final class InitServiceTests: TuistUnitTestCase {
    ...
    func test_init_default_when_no_template() throws {
        ...
        let expectedAttributes: [String: XcodeProjectGenerator.Template.Attribute.Value] = [
            "name": .string("Name"),
            "platform": .string("macOS"),
            "tuist_version": .string(tuistVersion),
        ]
        var generatorAttributes: [String: XcodeProjectGenerator.Template.Attribute.Value] = [:]
    ...
    func test_optional_dictionary_attribute_is_taken_from_template() async throws {
        // Given
        let context: XcodeProjectGenerator.Template.Attribute.Value = .dictionary([
            "key1": .string("value1"),
            "key2": .string("value2"),
        ])
    ...
    func test_optional_integer_attribute_is_taken_from_template() async throws {
        // Given
        let defaultIntegerValue: XcodeProjectGenerator.Template.Attribute.Value = .integer(999)
