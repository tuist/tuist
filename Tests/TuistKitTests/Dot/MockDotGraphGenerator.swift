...
final class MockGraphVizGenerator: GraphVizGenerating {
    ...
    func generateProject(at path: AbsolutePath, skipTestTargets _: Bool, skipExternalDependencies _: Bool, disableStyling _: Bool) throws -> GraphViz.Graph {
        generateProjectArgs.append(path)
        return generateProjectStub
    }

    func generateWorkspace(at path: AbsolutePath, skipTestTargets _: Bool, skipExternalDependencies _: Bool, disableStyling _: Bool) throws -> GraphViz.Graph {
