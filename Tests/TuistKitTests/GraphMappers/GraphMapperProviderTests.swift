...
final class GraphMapperProviderTests: TuistUnitTestCase {
    ...
    func test_mappers_returns_auto_generated_schemes_mapper_when_autogeneration_is_not_disabled() {
        // Given
        subject = GraphMapperProvider(useCache: false)
        ...
        // Then
        XCTAssertEqual(got.filter { $0 is AutogeneratedSchemesGraphMapper }.count, 1)
    }
}
