    ...
    func test_generate() throws {
        ...
        let expected = DependenciesGraph(
            externalDependencies: [
                "RxSwift": [.xcframework(path: .relativeToManifest("Tuist/Dependencies/Carthage/RxSwift.xcframework"))],
                "RxCocoa": [.xcframework(path: .relativeToManifest("Tuist/Dependencies/Carthage/RxCocoa.xcframework"))],
                "RxRelay": [.xcframework(path: .relativeToManifest("Tuist/Dependencies/Carthage/RxRelay.xcframework"))],
                "RxTest": [.xcframework(path: .relativeToManifest("Tuist/Dependencies/Carthage/RxTest.xcframework"))],
                "RxBlocking": [.xcframework(path: .relativeToManifest("Tuist/Dependencies/Carthage/RxBlocking.xcframework"))],
                "Alamofire": [.xcframework(path: .relativeToManifest("Tuist/Dependencies/Carthage/Alamofire.xcframework"))],
            ],
            externalProjects: [:]
        )
