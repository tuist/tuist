...
final class CarthageControllerTests: TuistUnitTestCase {
    ...
    func test_carthageVersion_carthageNotFound() {
        ...
        XCTAssertThrowsSpecific(
            try subject.carthageVersion(),
            CarthageControllerError.carthageNotFound
        )
    }

    func test_carthageVersion_success() {
        // Given
        system.stubs["/usr/bin/env carthage version"] = (
            stderror: nil, stdout: "0.37.0", exitstatus: 0
        )
    ...
    func test_bootstrap_with_platforms_throws_when_xcframeworkdProductionUnsupported() throws {
        ...
        system.stubs["/usr/bin/env carthage version"] = (
            stderror: nil, stdout: carthageVersion.description, exitstatus: 0
        )
        ...
        XCTAssertThrowsSpecific(
            ...
            CarthageControllerError.xcframeworksProductionNotSupported(
                installedVersion: carthageVersion
            )
        )
    }
