...
final class GitControllerTests: TuistUnitTestCase {
    ...
    func test_cloneTo() async throws {
        try await ServiceContext.withTestingDependencies {
            let url = "https://some/url/to/repo.git"
    ...
    func test_parsed_versions() async throws {
        try await ServiceContext.withTestingDependencies {
            let url = "https://some/url/to/repo.git"
    ...
    func test_currentCommitSHA() async throws {
        try await ServiceContext.withTestingDependencies {
            // Given
            let path = try temporaryPath()
    ...
    func test_urlOrigin() async throws {
        try await ServiceContext.withTestingDependencies {
            // Given
            let path = try temporaryPath()
            system.succeedCommand(
    ...
    func test_ref_when_githubRef() async throws {
        try await ServiceContext.withTestingDependencies {
            // When
            let got = subject.ref(
                environment: [
    ...
    func test_ref_when_codemagicPullRequestNumber() async throws {
        try await ServiceContext.withTestingDependencies {
            // When
            let got = subject.ref(
                environment: [
    ...
    func test_ref_when_circle_pull_request() async throws {
        try await ServiceContext.withTestingDependencies {
            // When
            let got = subject.ref(
                environment: [
    ...
    func test_inGitRepository_when_rev_parse_succeeds() async throws {
        try await ServiceContext.withTestingDependencies {
            // Given
            let path = try temporaryPath()
    ...
    func test_inGitRepository_when_rev_parse_fails() async throws {
        try await ServiceContext.withTestingDependencies {
            // Given
            let path = try temporaryPath()
    ...
    func test_current_branch_when_main() async throws {
        try await ServiceContext.withTestingDependencies {
            // Given
            let path = try temporaryPath()
    ...
    func test_current_branch_when_empty() async throws {
        try await ServiceContext.withTestingDependencies {
            // Given
            let path = try temporaryPath()
