...
let customAppScheme = WorkspaceScheme(name: "Workspace-App",
                                      ...
                                      testAction: .testAction(targets: [WorkspaceDescription.TestableTarget(target: WorkspaceDescription.TargetReference.project(path: "App", target: "AppTests"))]),
...
let customFrameworkScheme = WorkspaceScheme(name: "Workspace-Framework",
                                            ...
                                            testAction: .testAction(targets: [WorkspaceDescription.TestableTarget(target: WorkspaceDescription.TargetReference.project(path: "Frameworks/Framework1", target: "Framework1Tests"))]),
                                            archiveAction: .archiveAction(configurationName: "Debug", customArchiveName: "Something2"))
