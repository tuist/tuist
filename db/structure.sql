...
--
-- Name: index_accounts_on_owner; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_accounts_on_owner ON public.accounts USING btree (owner_type, owner_id);


--
-- Name: index_accounts_on_owner_id_and_owner_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: index_invitations_on_invitee_email_and_organization_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_invitations_on_invitee_email_and_organization_id ON public.invitations USING btree (invitee_email, organization_id);
...
--
-- Name: users fk_rails_cddfc1f87c; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT fk_rails_cddfc1f87c FOREIGN KEY (last_visited_project_id) REFERENCES public.projects(id);
