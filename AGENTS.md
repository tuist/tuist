...
- `swift-registry/` - Swift package registry service (Elixir/Phoenix) - see `swift-registry/AGENTS.md`
...
- `swift-registry` - Changes to the Swift package registry service
...
- `feat(swift-registry): add release sync allowlist`
