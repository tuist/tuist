defmodule Tuist.AWS.CredentialsTest do
  ...
  describe "get_token_file_credentials/1" do
    @tag :tmp_dir
    test "returns the right values when a token file is present and the region is not auto", %{
      tmp_dir: tmp_dir
    } do
      # Given
      ...
      Environment |> stub(:aws_region, fn -> "us-east-2" end)
      ...
      Req
      |> stub(:get!, fn "https://sts.us-east-2.amazonaws.com/",
                        form: %{
    ...
    @tag :tmp_dir
    test "returns the right values when a token file is present and the region is auto", %{
      tmp_dir: tmp_dir
    } do
      # Given
      Environment |> stub(:s3_endpoint, fn -> "https://s3.amazonaws.com" end)
