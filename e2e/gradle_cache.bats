...
#   - TUIST_EXECUTABLE: path to the tuist CLI binary (optional, defaults to "tuist")
...
setup_file() {
    ...
    # Configuration
    export TUIST_EXECUTABLE="${TUIST_EXECUTABLE:-tuist}"
    ...
    export TUIST_CACHE_ENDPOINT="http://localhost:${TUIST_CACHE_PORT:-8087}"
