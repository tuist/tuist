...
final class ProjectFileElementsTests: XCTestCase {
    ...
    func test_projectFiles() {
        ...
        let project = Project(path: AbsolutePath("/project/"),
                              name: "Project",
                              config: nil,
                              schemes: [],
                              settings: settings,
    ...
    func test_targetFiles() {
        ...
        let sourcesPhase = SourcesBuildPhase(buildFiles: BuildFiles.init(files: Set([AbsolutePath("/project/file.swift")])))
        let resourcesPhase = ResourcesBuildPhase(buildFiles: BuildFiles.init(files: Set([AbsolutePath("/project/image.png")])))
