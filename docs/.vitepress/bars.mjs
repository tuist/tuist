...
export function homeSidebar(locale) {
  return [
    {
      text: `<span style="display: flex; flex-direction: row; align-items: center; gap: 7px;">${localizedString(locale, "sidebars.home.items.welcome.text")} ${heartIcon()}</span>`,
      items: [
        {
          text: "Tuist",
          link: `/${locale}/`,
    ...
    {
      text: localizedString(locale, "sidebars.home.items.faq.text"),
    },
  ];
}
