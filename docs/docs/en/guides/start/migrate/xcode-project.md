...
<h1 id="migrate-an-xcode-project">Migrate an Xcode project</h1>
...
<h2 id="create-project-scaffold">Create project scaffold</h2>
...
<h2 id="build-and-test-the-tuist-project-in-ci">Build and test the Tuist project in CI</h2>
...
<h2 id="extract-the-project-build-settings-into-xcconfig-files">Extract the project build settings into `.xcconfig` files</h2>
...
<h2 id="extract-package-dependencies">Extract package dependencies</h2>
...
<h3 id="extract-the-target-build-settings-into-xcconfig-files">Extract the target build settings into `.xcconfig` files</h3>
...
<h3 id="define-the-target-in-the-projectswift-file">Define the target in the `Project.swift` file</h3>
...
<h3 id="validate-the-target-migration">Validate the target migration</h3>
...
<h3 id="compilation-errors-due-to-missing-files">Compilation errors due to missing files.</h3>
