...
Also make sure that the target doesn't depend either directly or indirectly on a <LocalizedLink href="/guides/features/cache/module-cache#supported-products">non-cacheable target</LocalizedLink>.
