...
The above suggestions are part of the [The Modular Architecture](/guide/project/tma-architecture), which we propose as a way to structure your projects to maximize the benefits not only of binary caching but also of Xcode's capabilities.
