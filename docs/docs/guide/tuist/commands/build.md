---
title: tuist build
description: "'tuist build' is a more user-friendly and feature-rich command to build projects."
---
...
| Platform | Available |
|----- | ----- |
| Apple (Native) | This command wraps `xcodebuild` making it more user-friendly and integrating it with Tuist's features |
...
- [**Analytics:**](/guide/analytics) It collects and reports metrics that are correlated with other data points to provide you with actionable information to make informed decisions.
