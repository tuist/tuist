...
| `المستندات`      | تغييرات التوثيق                | No release                  | `المستندات: دليل تثبيت التحديث`                     |
| `النمط`          | تغييرات نمط الكود              | No release                  | `النمط: تنسيق الرمز باستخدام سويفت فورمات`          |
| `إعادة البناء`   | إعادة هيكلة التعليمات البرمجية | No release                  | `إعادة هيكلة (الخادم): تبسيط منطق المصادقة`         |
| `الكمال`         | تحسينات الأداء                 | نتوء إصدار التصحيح          | `بيرف(cli): تحسين دقة التبعية`                      |
| `الاختبار`       | اختبار الإضافات/التغييرات      | No release                  | `الاختبار: إضافة اختبارات الوحدة للتخزين المؤقت`    |
| `العمل الروتيني` | مهام الصيانة                   | No release                  | `العمل الروتيني: تحديث التبعيات`                    |
| `ci`             | تغييرات CI/CDD                 | No release                  | `ci: إضافة سير عمل للإصدارات`                       |
