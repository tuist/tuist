...
| ---------------- | ------------------------------ | --------------------------- | --------------------------------------------------- |
| `الفذ`           | ميزة أو قدرة جديدة             | نتوء الإصدار البسيط (x.Y.z) | `ميزة (cli): إضافة دعم ل Swift 6`                   |
...
5. **التوزيع**: يتم دفع التحديثات إلى مديري الحزم (على سبيل المثال، Homebrew for
   CLI)
...
### لا تفعل
- استخدام رسائل غامضة مثل "إصلاح الخلل" أو "تحديث الكود"
