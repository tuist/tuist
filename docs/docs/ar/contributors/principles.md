...
## افتراضي إلى الاتفاقيات {#default-to-conventions}
...
## اجعل الضمني صريحًا {#make-the-implicit-explicit}
...
## اجعل الأمر بسيطًا {#keep-it-simple}
...
## الأخطاء يمكن أن تحدث وستحدث {#errors-can-and-will-happen}
