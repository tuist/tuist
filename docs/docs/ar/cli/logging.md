...
بشكل افتراضي، تقوم CLI بإخراج مسار السجلات عند خروج التنفيذ بشكل غير متوقع. إذا
لم يحدث ذلك، يمكنك العثور على السجلات في المسار المذكور أعلاه (أي أحدث ملف سجل).
