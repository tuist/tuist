...
| `tuist_secret_secret_key_password`           | الفلفل لإنشاء كلمات مرور مجزأة                                                                                                                                                                   | لا يوجد | `$TUIST_SECRET_KEY_BASE`             |                                                                              |                                                                                                                                    |
| `tuist_secret_secret_key_tokens`             | المفتاح السري لتوليد رموز عشوائية                                                                                                                                                                | لا يوجد | `$TUIST_SECRET_KEY_BASE`             |                                                                              |                                                                                                                                    |
| `tuist_secret_secret_key_encryption`         | مفتاح 32 بايت لتشفير AES-GCM للبيانات الحساسة                                                                                                                                                    | لا يوجد | `$TUIST_SECRET_KEY_BASE`             |                                                                              |                                                                                                                                    |
