...
### `tuist_runs_total` (عداد) {#tuist_runs_total-counter}

إجمالي عدد مرات تشغيل تويست.

#### الوسوم {#tuist-runs-total-tags}
...
### `tuist_runs_duration_duration_milliseconds` (رسم بياني) {#tuist_runs_duration_milliseconds-histogram}

المدة الإجمالية لكل تشغيل تويست بالمللي ثانية.

#### العلامات {#tuist-runs-duration-miliseconds-tags}
...
### `tuist_cache_cache_events_total` (عداد) {#tuist_cache_events_total-counter}

إجمالي عدد أحداث ذاكرة التخزين المؤقت الثنائية.

#### الوسوم {#tuist-cache-events-total-tags}

| الوسم       | الوصف                                                            |
| ----------- | ---------------------------------------------------------------- |
| `نوع_الحدث` | يمكن أن يكون إما من `إصابة محلية` أو `إصابة عن بُعد` أو `تفويت`. |

### `tuist_cache_cuploads_uploads_total` (عداد) {#tuist_cache_uploads_total-counter}

عدد عمليات التحميل إلى ذاكرة التخزين المؤقت الثنائية.

### `tuist_cache_cache_uploaded_bytes` (المجموع) {#tuist_cache_uploaded_bytes-sum}

عدد وحدات البايت التي تم تحميلها إلى ذاكرة التخزين المؤقت الثنائية.

### `tuist_cache_cdownloads_downloads_total` (عداد) {#tuist_cache_downloads_total-counter}

عدد التنزيلات إلى ذاكرة التخزين المؤقت الثنائية.

### `tuist_cache_cache_downloaded_bytes` (المجموع) {#tuist_cache_downloaded_bytes-sum}
...
### `tuist_previews_previews_uploads_total` (المجموع) {#tuist_previews_uploads_total-counter}
...
### `tuist_storage_get_get_object_size_size_size_size_bytes` (رسم بياني) {#tuist_storage_get_object_size_size_bytes-histogram}

حجم (بالبايت) الكائن الذي تم جلبه من وحدة التخزين البعيدة.

#### العلامات {#tuist-storage-get-object-size-size-bytes-tags}
...
### `tuist_storage_get_get_object_size_size_duration_miliseconds` (رسم بياني) {#tuist_storage_get_object_size_duration_miliseconds-histogram}

المدة (بالمللي ثانية) لجلب حجم كائن من وحدة التخزين البعيدة.

#### العلامات {#tuist-storage-get-object-size-duration-miliseconds-tags}
...
### `tuist_storage_get_get_obget_size_size_count` (عداد) {#tuist_storage_get_object_size_count-counter}

عدد المرات التي تم فيها جلب حجم الكائن من وحدة التخزين عن بُعد.

#### العلامات {#tuist-storage-get-object-size-count-tags}

| الوسم          | الوصف                                          |
| -------------- | ---------------------------------------------- |
| `مفتاح_الكائن` | مفتاح البحث عن الكائن في وحدة التخزين البعيدة. |

### `tuist_storage_delete_all_dall_objects_duration_milliseconds_milliseconds` (رسم بياني) {#tuist_storage_delete_all_objects_duration_milliseconds-histogram}

المدة (بالمللي ثانية) لحذف جميع الكائنات من وحدة التخزين البعيدة.

#### العلامات {#tuist-storage-delete-all-objects-duration-milliseconds-tags}
...
### `tuist_storage_delete_all_storage_delete_all_objects_counts_count` (عداد) {#tuist_storage_delete_all_objects_count-counter}

عدد المرات التي تم فيها حذف جميع كائنات المشروع من وحدة التخزين عن بُعد.

#### العلامات {#tuist-storage-delete-all-objects-count-tags}
...
### `tuist_storage_multipart_start_start_upart_upart_upart_upload_duration_milliseconds` (رسم بياني) {#tuist_storage_multipart_start_upload_duration_milliseconds-histogram}

المدة (بالمللي ثانية) لبدء التحميل إلى وحدة التخزين البعيدة.

#### العلامات {#tuist-storage-multipart-start-upload-duration-milliseconds-tags}

| الوسم          | الوصف                                          |
| -------------- | ---------------------------------------------- |
| `مفتاح_الكائن` | مفتاح البحث عن الكائن في وحدة التخزين البعيدة. |

### `tuist_storage_multipart_start_start_upart_upload_dupuration_duration_count` (عداد) {#tuist_storage_multipart_start_upload_duration_count-counter}

عدد مرات بدء التحميل إلى وحدة التخزين عن بُعد.

#### العلامات {#tuist-storage-multipart-start-upload-duration-count-tags}
...
### `tuist_storage_get_get_object_as_string_duration_milliseconds` (رسم بياني) {#tuist_storage_get_object_as_string_duration_milliseconds-histogram}

المدة (بالمللي ثانية) لجلب كائن كسلسلة من وحدة التخزين البعيدة.

#### العلامات {#tuist-storage-get-object-as-string-duration-milliseconds-tags}

| الوسم          | الوصف                                          |
| -------------- | ---------------------------------------------- |
| `مفتاح_الكائن` | مفتاح البحث عن الكائن في وحدة التخزين البعيدة. |

### `tuist_storage_get_get_object_as_string_count` (العد) {#tuist_storage_get_object_as_string_count-count}

عدد المرات التي تم فيها جلب كائن كسلسلة من وحدة التخزين البعيدة.

#### الوسوم {#tuist-storage-get-object-as-string-count-tags}
...
### `tuist_storage_stcheck_object_existence_dexence_duration_milliseconds` (رسم بياني) {#tuist_storage_check_object_existence_duration_milliseconds-histogram}

المدة (بالمللي ثانية) للتحقق من وجود كائن في وحدة التخزين البعيدة.

#### العلامات {#tuist-storage-check-object-existence-duration-milliseconds-tags}

| الوسم          | الوصف                                          |
| -------------- | ---------------------------------------------- |
| `مفتاح_الكائن` | مفتاح البحث عن الكائن في وحدة التخزين البعيدة. |

### `tuist_storage_stecheck_object_exist_existence_count` (العد) {#tuist_storage_check_object_existence_count-count}

عدد المرات التي تم فيها التحقق من وجود كائن في المخزن البعيد.

#### العلامات {#tuist-storage-check-object-existence-count-tags}

| الوسم          | الوصف                                          |
| -------------- | ---------------------------------------------- |
| `مفتاح_الكائن` | مفتاح البحث عن الكائن في وحدة التخزين البعيدة. |

### `tuist_storage_generate_download_download_presigned_url_url_durl_duration_milliseconds` (رسم بياني) {#tuist_storage_generate_download_presigned_url_duration_milliseconds-histogram}
...
### `tuist_storage_generate_downloadate_download_presigned_url_url_count` (العد) {#tuist_storage_generate_download_presigned_url_count-count}
...
### `tuist_storage_multipart_generate_upload_upload_part_presigned_purl_purl_purl_milliseconds_milliseconds` (رسم بياني) {#tuist_storage_multipart_generate_upload_part_presigned_url_duration_milliseconds-histogram}

المدة (بالمللي ثانية) لإنشاء عنوان URL محدد مسبقاً لتحميل جزء من التحميل لكائن
في وحدة التخزين البعيدة.

#### العلامات {#tuist-storage-multipart-generate-upload-part-presigned-url-duration-milliseconds-tags}
...
### `tuist_storage_multipart_generate_upload_upload_part_presigned_purl_count` (العد) {#tuist_storage_multipart_generate_upload_part_presigned_url_count-count}

عدد المرات التي تم فيها إنشاء عنوان URL محدد مسبقاً لتحميل جزء لكائن في وحدة
التخزين البعيدة.

#### العلامات {#tuist-storage-multipart-generate-upload-part-presigned-url-count-tags}
...
### `tuist_storage_multipart_complete_compload_uplete_upload_duration_milliseconds` (رسم بياني) {#tuist_storage_multipart_complete_upload_duration_milliseconds-histogram}

المدة (بالمللي ثانية) لإكمال التحميل إلى وحدة التخزين البعيدة.

#### العلامات {#tuist-storage-multipart-complete-upload-duration-milliseconds-tags}
...
### `tuist_storage_storage_multipart_complete_complete_upload_count` (العد) {#tuist_storage_multipart_complete_upload_count-count}

العدد الإجمالي لمرات اكتمال التحميل إلى وحدة التخزين عن بُعد.

#### العلامات {#tuist-storage-multipart-complete-upload-count-tags}
...
### `tuist_authentication_authentication_token_refresh_refresh_error_total` (عداد) {#tuist_authentication_token_refresh_error_total-counter}

العدد الإجمالي لأخطاء تحديث الرمز المميز.

#### العلامات {#tuist-authentication-token-refresh-error-total-tags}
...
### `tuist_accounts_accounts_organizations_total` (آخر_قيمة) {#tuist_accounts_organizations_total-last_value}

إجمالي عدد المنظمات.

### `tuist_accounts_accounts_accounts_users_total` (آخر_قيمة) {#tuist_accounts_users_total-last_value}
...
### `tuist_repo_repo_pool_checkout_queout_queue_length` (آخر_قيمة) {#tuist_repo_pool_checkout_queue_length-last_value}

عدد استعلامات قاعدة البيانات الموجودة في قائمة الانتظار في انتظار تعيينها لاتصال
قاعدة البيانات.

### `tuist_repo_repo_repo_pool_ready_conn_count` (آخر_قيمة) {#tuist_repo_pool_ready_conn_count-last_value}

عدد اتصالات قاعدة البيانات الجاهزة للتعيين لاستعلام قاعدة البيانات.


### `tuist_repo_repo_dpool_dpool_db_db_connection_connconnected` (عداد) {#tuist_repo_pool_db_connection_connected-counter}

عدد الاتصالات التي تم إنشاؤها بقاعدة البيانات.

### `tuist_repo_repo_pool_db_db_db_dconnection_disconnected` (عداد) {#tuist_repo_pool_db_connection_disconnected-counter}
...
### `tuist_http_http_request_count` (عداد) {#tuist_http_request_count-last_value}

عدد طلبات HTTP الصادرة.

### `tuist_http_http_request_request_duration_nanosecond_nanosecond_sum` (المجموع) {#tuist_http_request_duration_nanosecond_sum-last_value}

مجموع مدة الطلبات الصادرة (بما في ذلك الوقت الذي استغرقته في انتظار تعيين
اتصال).

### `tuist_http_http_request_request_duration_nanosecond_nanosecond_bucket` (التوزيع) {#tuist_http_request_duration_nanosecond_bucket-distribution}
توزيع مدة الطلبات الصادرة (بما في ذلك الوقت الذي استغرقته في انتظار تعيين
اتصال).

### `tuist_http_http_queue_count` (عداد) {#tuist_http_queue_count-counter}

عدد الطلبات التي تم استردادها من المجمع.

### `tuist_http_http_queue_due_due_duration_nanoseconds_nanoseconds_sum` (المجموع) {#tuist_http_queue_duration_nanoseconds_sum-sum}

الوقت الذي يستغرقه استرداد اتصال من المجمع.

### `tuist_http_http_quettp_queue_queue_idue_time_nanoseconds_nanoseconds_nanoseconds_sum` (المجموع) {#tuist_http_queue_idle_time_nanoseconds_sum-sum}

الوقت الذي ظل فيه الاتصال خاملاً في انتظار الاسترداد.

### `tuist_http_http_queue_due_due_duration_nanoseconds_nanoseconds_bucket` (التوزيع) {#tuist_http_queue_duration_nanoseconds_bucket-distribution}

الوقت الذي يستغرقه استرداد اتصال من المجمع.

### `tuist_http_http_quettp_queue_queue_idue_idue_time_nanoseconds_nanoseconds_nanoseconds_bucket` (التوزيع) {#tuist_http_queue_idle_time_nanoseconds_bucket-distribution}

الوقت الذي ظل فيه الاتصال خاملاً في انتظار الاسترداد.

### `tuist_http_http_connection_count` (عداد) {#tuist_http_connection_count-counter}

عدد الاتصالات التي تم إنشاؤها.

### `tuist_http_http_donnection_donnection_duration_nanoseconds_nanoseconds_sum` (المجموع) {#tuist_http_connection_duration_nanoseconds_sum-sum}

الوقت الذي يستغرقه إنشاء اتصال مقابل مضيف.

### `tuist_http_http_donnection_dconnection_duration_nanoseconds_nanoseconds_nanoseconds_bucket` (التوزيع) {#tuist_http_connection_duration_nanoseconds_bucket-distribution}

توزيع الوقت الذي يستغرقه إنشاء اتصال مقابل مضيف.

### `tuist_http_http_send_count` (عداد) {#tuist_http_send_count-counter}

عدد الطلبات التي تم إرسالها بمجرد تعيينها إلى اتصال من مجموعة الاتصالات.

### `tuist_http_http_send_send_duration_nanoseconds_nanoseconds_nanoseconds_sum` (المجموع) {#tuist_http_send_duration_nanoseconds_sum-sum}

الوقت الذي تستغرقه الطلبات لإكمالها بمجرد تعيينها إلى اتصال من مجموعة الاتصالات.

### `tuist_http_http_send_send_duration_nanoseconds_nanoseconds_nanoseconds_bucket` (التوزيع) {#tuist_http_send_duration_nanoseconds_bucket-distribution}

توزيع الوقت الذي تستغرقه الطلبات لإكمالها بمجرد تعيينها إلى اتصال من مجموعة
الاتصالات.

### `tuist_http_http_receive_count` (عداد) {#tuist_http_receive_count-counter}

عدد الردود التي تم استلامها من الطلبات المرسلة.

### `tuist_http_http_receive_dreceive_duration_nanoseconds_nanoseconds_sum` (المجموع) {#tuist_http_receive_duration_nanoseconds_sum-sum}

الوقت المستغرق في تلقي الردود.

### `tuist_http_http_receive_dreceive_duration_nanoseconds_nanoseconds_nanoseconds_bucket` (التوزيع) {#tuist_http_receive_duration_nanoseconds_bucket-distribution}

توزيع الوقت المستغرق في تلقي الردود.

### `tuist_http_http_queue_available_avconnections` (آخر_قيمة) {#tuist_http_queue_available_connections-last_value}

عدد الاتصالات المتوفرة في قائمة الانتظار.

### `tuist_http_http_queue_in_in_use_connections` (آخر_قيمة) {#tuist_http_queue_in_use_connections-last_value}
