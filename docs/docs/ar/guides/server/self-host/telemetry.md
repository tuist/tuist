...
| ------------------------------- | --------------------------------------------------- | ----- | ------- | --------------------------------------------------------------- |
| `tuist_posthog_api_key_API_key` | مفتاح واجهة برمجة التطبيقات لمشروع PostHog الخاص بك | لا    |         | `phc_fpR9c0Hs5Hs5H5H5VXXUsupUsupU1I0WLWLEq366FaZH6H6HJR3lRIWVR` |
| `tuist_posthog_url`             | عنوان URL نقطة نهاية واجهة برمجة تطبيقات PostHog    | لا    |         | `https://eu.i.posthog.com`                                      |
