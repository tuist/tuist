...
<LocalizedLink href="/guides/features/projects">الخاصة بـ مشروع تويست</LocalizedLink>،
...
ويتكامل Tuist الآن بسلاسة معها - بغض النظر عما إذا كنت تستخدم إمكانيات <LocalizedLink href="/guides/features/projects">توليد المشاريع</LocalizedLink> الخاصة بـ Tuist أم لا.
