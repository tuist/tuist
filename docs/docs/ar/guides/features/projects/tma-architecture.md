...
## ما هي الوحدة النمطية {#ما هي الوحدة النمطية}
...
:::: إكرامية معاينات واجهة المستخدم
<!-- -->
`الميزة` يمكن استخدام `FeatureTesting` كأصل تطوير للسماح بمعاينة واجهة المستخدم
<!-- -->
:::

:::: التحذير من تجميع التوجيهات بدلاً من اختبار الأهداف
<!-- -->
...
## لماذا وحدة نمطية {#لماذا وحدة نمطية}

### واجهات برمجة التطبيقات الواضحة والموجزة {#واضحة وموجزة-APIs}
...
### قابلية إعادة الاستخدام {# قابلية إعادة الاستخدام}
...
ملحقات الحزمة</LocalizedLink> لفصل منطق الوصول إلى الحزمة عن طبيعة المكتبة أو
...
التكوين الديناميكي</LocalizedLink> لتغيير نوع المنتج في وقت الإنشاء:
