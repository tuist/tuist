...
### الأنماط المثبطة {#الأنماط المثبطة}

#### التكوينات لنمذجة البيئات البعيدة {# التكوينات لنمذجة البيئات البعيدة}
...
:::: معلومات التكوينات غير القياسية
<!-- -->
