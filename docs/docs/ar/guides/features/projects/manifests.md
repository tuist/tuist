...
يستخدم تويست بشكل افتراضي ملفات سويفت كطريقة أساسية لتحديد المشاريع ومساحات
العمل وتهيئة عملية الإنشاء. يُشار إلى هذه الملفات باسم ملفات البيان **** في جميع
أنحاء الوثائق.
...
::: info CACHING
<!-- -->
نظرًا لأن ملفات البيان هي ملفات Swift التي تحتاج إلى تجميعها، يقوم Tuist بتخزين
...
تحتاج إلى تضمينها يدويًا. هذا ضروري لنظام الإنشاء لحل التبعيات بشكل صحيح.
<!-- -->
:::
