...
يكمن الفرق في تجربة التحرير. باستخدام تويست، يمكنك تشغيل الأمر `tuist edit` الذي
يُنشئ مشروع Xcode سريعًا يمكنك فتحه وبدء العمل عليه. هذا مفيد بشكل خاص عندما
تريد إجراء تغييرات سريعة على مشروعك.
...
أحد عيوب YAML كلغة لتكوين المشروع هو أنها لا تدعم إمكانية إعادة الاستخدام عبر
