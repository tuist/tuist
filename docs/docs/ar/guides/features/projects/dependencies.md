...
::: تلميح التحقق من صحة الرسم البياني
<!-- -->
...
#### التكامل المستند إلى XcodeProj من تويست {#tuists-xcodeprojbased-integration}
...
<LocalizedLink href="/guides/features/cache"> التخزين المؤقت</LocalizedLink> و
<LocalizedLink href="/guides/features/test/selective-testing">عمليات التشغيل الاختبار الانتقائي</LocalizedLink>.
...
#### التكامل الافتراضي ل Xcode {#xcodes-default-integration}
...
والديناميكي ويصنع
<LocalizedLink href="/guides/features/projects/synthesized-files#bundle-accessors"> حزمة من الملحقات</LocalizedLink> التي تكون قياسية عبر أنواع الربط. بالاقتران مع
<LocalizedLink href="/guides/features/projects/dynamic-configuration">التكوينات الديناميكية عبر متغيرات البيئة</LocalizedLink>، يمكنك تمرير نوع الربط في وقت
...
لاحظ أن تويست
<LocalizedLink href="/guides/features/projects/cost-of-convenience">لا يقوم بشكل افتراضي بالراحة من خلال التكوين الضمني بسبب تكاليفه</LocalizedLink>. ما
...
#### تأكد من إضافة `-ObjC` إلى `OTHER_LDFLAGS` {#ensure-objc-is-added-to-other_ldflags}
...
أو المكتبة، مما قد
<LocalizedLink href="https://forums.swift.org/t/compiling-a-dynamic-framework-with-a-statically-linked-library-creates-dependencies-in-swiftmodule-file/22708/1"> يتسبب في فشل التجميع </LocalizedLink>. ولمنع ذلك، سيتعين عليك استيراد التبعية
الثابتة باستخدام
<LocalizedLink href="https://github.com/swiftlang/swift-evolution/blob/main/proposals/0409-access-level-on-imports.md">`الاستيراد الداخلي`</LocalizedLink>:
...
::: info
<!-- -->
تم تضمين مستوى الوصول على الواردات في Swift 6. إذا كنت تستخدم إصدارات أقدم من
سويفت، فعليك استخدام
<LocalizedLink href="https://github.com/apple/swift/blob/main/docs/ReferenceGuides/UnderscoredAttributes.md#_implementationonly">`@_التنفيذ فقط`</LocalizedLink> بدلاً من ذلك:
<!-- -->
:::
