...
أحد عيوب Xcode عند استخدامه في المشاريع الكبيرة هو أنه لا يسمح بإعادة استخدام
...
- يسهل ذلك صيانة **** لأن التغييرات يمكن تطبيقها في مكان واحد وتطبق على جميع
  المشاريع تلقائيًا.
...
يجب على مولدات المشاريع القائمة على YAML ابتكار حلول قوالب خاصة بها قائمة على
YAML، أو إجبار المؤسسات على بناء أدواتها عليها.
<!-- -->
:::

## مساعدو وصف المشروع {#project-description-helpers}

مساعدو وصف المشروع هم ملفات Swift يتم تجميعها في وحدة نمطية،
...
<!-- -->
لاحظ كيف نحدد من خلال الوظيفة قواعد بشأن اسم الأهداف ومعرف الحزمة وهيكل
المجلدات.
<!-- -->
:::
