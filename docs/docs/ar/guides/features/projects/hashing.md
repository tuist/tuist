...
1. قم بتشغيل `تويست` أو `تويست تجزئة الاختبار الانتقائي` (تجزئات لـ
   <LocalizedLink href="/guides/features/cache">تخزين مؤقت ثنائي</LocalizedLink> أو
   <LocalizedLink href="/guides/features/selective-testing">اختبار انتقائي</LocalizedLink>)، انسخ التجزئات، وأعد تسمية دليل المشروع، ثم قم
...
::: info تم تخطيط تجربة أفضل للتحقق من المعلومات
<!-- -->
