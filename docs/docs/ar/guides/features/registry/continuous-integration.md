...
التشغيل الآلي مثل [Fastlane] (https://fastlane.tools/) تنشئ بالفعل سلسلة مفاتيح
مؤقتة أو توفر طريقة مدمجة لكيفية إنشاء واحدة. ومع ذلك، يمكنك أيضًا إنشاء واحدة
من خلال إنشاء خطوة مخصصة باستخدام التعليمات البرمجية التالية:
```bash
...
تكون عمليات الحل النظيفة/الباردة أسرع قليلاً مع السجل الخاص بنا، ويمكنك تجربة
