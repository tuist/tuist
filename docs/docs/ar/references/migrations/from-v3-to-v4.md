...
::: warning الاختلاط في بيئات CI ومشاريع XCODE
<!-- -->
...
### [إمكانيات التوقيع المسقطة] (https://github.com/tuist/tuist/pull/5716) {#1} {#dropped-signing-capabilitieshttpsgithubcomtuisttuistpull5716}
