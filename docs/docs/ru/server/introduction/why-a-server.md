...
We believe teams shouldn't have to worry about setting up and maintaining a server to scale their projects. That's why we built a server that [Tuist](/ru/guides/develop/projects) and [Xcode projects](https://developer.apple.com/documentation/xcode/creating-an-xcode-project-for-an-app) can integrate with to scale their projects and teams.
...
> Some superpowers like [binary caching](/ru/guides/develop/build/cache) require you to have a [Tuist project](/ru/guides/develop/projects) but others just work with vanilla Xcode projects.
