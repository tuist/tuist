...
установить автодополнение для оболочек Bash и Zsh, чтобы автоматически дополнять
команды и опции.

::: warning WHAT IS A GLOBAL INSTALLATION
<!-- -->
Глобальная установка — это установка, доступная в переменной среды `$PATH` вашей
оболочки. Это означает, что вы можете запустить `tuist` из любого каталога в
терминале. Это метод установки по умолчанию для Homebrew.
<!-- -->
:::
...
Скопируйте ваш новый скрипт автодополнения в новый файл в этом каталоге с именем
`_tuist`:
...
Без `oh-my-zsh` вам нужно будет добавить путь к скриптам автодополнения в путь
функций и включить автозагрузку скриптов автодополнения. Сначала добавьте эти
строки в `~/.zshrc`:
