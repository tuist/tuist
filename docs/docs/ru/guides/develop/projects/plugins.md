...
- [Project description helpers](/ru/guides/develop/projects/code-sharing) across multiple projects.
- [Templates](/ru/guides/develop/projects/templates) across multiple projects.
- Tasks across multiple projects.
- [Resource accessor](/ru/guides/develop/projects/synthesized-files) template across multiple projects
...
If you need to share [synthesized resource accessors](/ru/guides/develop/projects/synthesized-files#resource-accessors) you can use
...
To use a plugin, you'll have to add it to your project's [`Config.swift`](/ru/references/project-description/structs/config) manifest file:
