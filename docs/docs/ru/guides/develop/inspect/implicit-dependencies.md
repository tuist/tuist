...
> [!TIP] VALIDATE IN CI
> We strongly recommend to run this command as part of your [continuous integration](/ru/guides/develop/automate/continuous-integration) command every time new code is pushed upstream.
