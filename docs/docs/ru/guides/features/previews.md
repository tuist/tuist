...
часто приводит к тому, что разработчики вообще не тестируют функциональность на
своем устройстве. Но *что, если бы каждый запрос на сборку содержал ссылку на
сборку, которая автоматически запускала бы приложение на устройстве, выбранном в
приложении Tuist macOS?*
