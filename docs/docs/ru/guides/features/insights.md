...
- Медленнее ли мои сборки на CI по сравнению с локальной разработкой?
...
::: info
<!-- -->
Автоматически созданные схемы автоматически включают `tuist inspect build`
post-action.
<!-- -->
:::
> 
> Если вам неинтересно отслеживать сведения в автогенерируемых схемах, отключите
> их с помощью опции генерации
...
файлы журнала активности и пакета результатов не создаются. Пост-акция `tuist
inspect build` требует эти файлы для анализа ваших сборок.
