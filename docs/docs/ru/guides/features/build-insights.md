...
построек](/images/guides/features/build-insights/inspect-build-scheme-post-action.png)
...
сборке](/images/guides/features/build-insights/builds-dashboard.png)
...
тестов](/images/guides/features/build-insights/inspect-test-scheme-post-action.png)
...
тестов](/images/guides/features/build-insights/tests-dashboard.png)
...
![Подробности теста](/images/guides/features/build-insights/test-detail.png)
