...
Tuist предоставляет
<LocalizedLink href="/contributors/principles#default-to-conventions">целесообразные значения по умолчанию</LocalizedLink> для упрощения конфигурации проекта.
