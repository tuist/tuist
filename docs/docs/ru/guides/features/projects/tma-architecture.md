...
| ------------------ | --------------------------- | ----------------------------------- |
| `Feature`          | `FeatureInterface`          | Исходный код и ресурсы              |
| `FeatureInterface` | -                           | Публичный интерфейс и модели        |
| `FeatureTests`     | `Feature`, `FeatureTesting` | Модульные и интеграционные тесты    |
...
::: tip ПРЕДПРОСМОТРЫ ПОЛЬЗОВАТЕЛЬСКОГО ИНТЕРФЕЙСА
<!-- -->
`Feature` может использовать `FeatureTesting` в качестве актива разработки,
чтобы обеспечить предварительный просмотр пользовательского интерфейса
<!-- -->
:::

::: warning КОМПИЛЯТОР ДИРЕКТИВОВ ВМЕСТО ТЕСТОВЫХ ТАРГЕТОВ
<!-- -->
...
- [Путешествие во фреймворк и Swift]
