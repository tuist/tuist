---
title: Code sharing titleTemplate: :title · Projects · Features · Guides · Tuist
description: Learn how to share code across manifest files to reduce
duplications and ensure consistency
---
