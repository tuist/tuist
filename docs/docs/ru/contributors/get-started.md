...
- (Optional) Run `tuist auth` to get access to the [Tuist Cache](/ru/guides/develop/build/cache)
...
If you needed to edit the project, for example to add dependencies or adjust targets, you can use the [`tuist edit` command](/ru/guides/develop/projects/editing). This is barely used, but it's good to know that it exists.
