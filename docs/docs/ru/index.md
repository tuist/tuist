...
hero:
  ...
  actions:
    - theme: brand
      text: What is Tuist?
      link: /ru/guides/tuist/about
    - theme: alt
      text: Quick start
      link: /ru/guides/quick-start/install-tuist
    - theme: alt
      text: View on GitHub
...
features:
  - icon: 📝
    ...
    link: "/ru/guides/develop/projects"
  - icon: 📦
    title: Cache
    details: |
