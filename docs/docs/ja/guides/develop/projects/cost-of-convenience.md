...
<h1 id="the-cost-of-convenience">The cost of convenience</h1>
...
<h2 id="explicitness-and-scale">Explicitness and scale</h2>
...
<h2 id="convenience-getting-in-your-way">Convenience getting in your way</h2>

<h3 id="shared-built-products-directory">Shared built products directory</h3>
...
<h3 id="find-implicit-dependencies-in-schemes">Find implicit dependencies in schemes</h3>
...
<h3 id="swiftui-previews-and-static-librariesframeworks">SwiftUI Previews and static libraries/frameworks</h3>
...
<h3 id="mergeable-libraries">Mergeable libraries</h3>
...
```bash
<h1 id="the-value-of-tuist_dynamic-can-be-read-from-the-project">The value of TUIST_DYNAMIC can be read from the project</h1>
<h1 id="to-set-the-product-as-static-or-dynamic-based-on-the-value">to set the product as static or dynamic based on the value.</h1>
TUIST_DYNAMIC=1 tuist generate
```

<h2 id="explicit-explicit-and-explicit">Explicit, explicit, and explicit</h2>
