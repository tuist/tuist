...
# 배포하는 개발자를 위한 가상 플랫폼 팀

**Tuist는 Apple의 툴체인을 확장해 팀이 성장하고 앱 개발에 집중할 수 있도록 돕습니다** – 복잡하고 혼란스러운 Apple 플랫폼
개발을 팀과 함께 성장하는 원할하고 생산적인 경험으로 변화시켜 줍니다.
...
## Tuist로 전환한 수천 명의 개발자와 함께하세요

**[Trendyol](https://www.trendyol.com/), [Etsy](https://www.etsy.com/),
[Bumble](https://bumble.com/), [Monzo](https://monzo.com/), [Bending
Spoons](https://bendingspoons.com/)를 비롯한 100개 이상의 기업**은 이미 Tuist를 통해 Apple 플랫폼
개발방식을 개선했습니다. 이들이 어떠한 경험을 했는지 확인해 보세요:

- 지능형 캐싱으로 **빌드 속도 65% 향상**
- Xcode 프로젝트에서 **병합 충돌 문제 완전 해소**
- 패키지 의존성 관리 시간이 **몇 분에서 몇 초로 단축**
- 기능 개발에 집중할 수 있는 **행복한 개발자**
...
## Tuist가 어떻게 동작하는지 확인하세요

**실제 구현으로 배우고** 툴체인이 동작하면 무엇을 할 수 있는지 살펴보면서 영감을 얻어보세요.

<HomeVideos/>

## 활발한 커뮤니티에 함께하세요

Tuist로 더 나은 앱을 출시하고 있는 **수천 명의 Apple 플랫폼 개발자와 소통하세요**. 도움을 주고받고, 성공 사례를 공유하며,
Apple 플랫폼 개발의 미래를 함께 만들어가세요.
