---
title: Get started titleTemplate: :title · Contributors · Tuist description: Get
started contributing to Tuist by following this guide.
---
...
> [!NOTE] XED . If you try to open the project using `xed .`, it will open the
