...
`Project.swift`는 프로젝트를 정의하는 매니페스트 파일이며, `Package.swift`는 의존성을 정의하는 매니페스트 파일입니다. The `Tuist.swift` file is where you can define project-scoped Tuist settings for your project.
