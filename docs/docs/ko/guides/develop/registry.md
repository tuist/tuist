...
이제 레지스트리에 접근할 수 있습니다! To resolve dependencies from the registry instead of from source control, continue reading based on your project setup:
