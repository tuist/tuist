...
我们通过[GitHub容器注册表](https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-container-registry)以[Docker](https://www.docker.com/)镜像形式分发服务器。
