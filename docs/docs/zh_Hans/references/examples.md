...
在本节中，您将看到<LocalizedLink to="/guides/features/projects">生成项目</LocalizedLink>的示例，我们将其用作[固定装置](https://github.com/tuist/tuist/tree/main/examples/xcode)来运行验收测试。在创建新的生成项目或将现有
