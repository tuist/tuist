...
![檢查建置的後續動作](/images/guides/features/build-insights/inspect-build-scheme-post-action.png)。
...
![儀表板與建立洞察力](/images/guides/features/build-insights/builds-dashboard.png)。
...
![檢查測試的後續動作](/images/guides/features/build-insights/inspect-test-scheme-post-action.png)。
...
![具有測試洞察力的儀表板](/images/guides/features/build-insights/tests-dashboard.png)。

除了整體趨勢之外，您也可以深入研究每一個測試，例如在 CI 上除錯失敗或緩慢的測試時：

![測試細節](/images/guides/features/build-insights/test-detail.png)。
