...
if config_env() == :prod do
  ...
  http_config =
    case socket_path do
      ...
      path ->
        ...
        Application.put_env(:tuist_registry, :socket_path, unique_path)
  ...
  sentry_dsn = env.(["SENTRY_DSN_REGISTRY", "SENTRY_DSN_CACHE"])
  ...
  config :tuist_registry, :oban_web_basic_auth,
  ...
  config :tuist_registry,
    ...
    disk_usage_high_watermark_percent: TuistRegistry.Config.float_env("DISK_HIGH_WATERMARK_PERCENT", 75.0),
    disk_usage_target_percent: TuistRegistry.Config.float_env("DISK_TARGET_PERCENT", 60.0),
    api_key: env.(["TUIST_REGISTRY_SWIFT_API_KEY", "TUIST_CACHE_API_KEY"]),
    analytics_failure_threshold: TuistRegistry.Config.int_env("ANALYTICS_FAILURE_THRESHOLD", 3),
    analytics_cooldown_ms: TuistRegistry.Config.int_env("ANALYTICS_COOLDOWN_MS", 60_000),
    analytics_receive_timeout_ms: TuistRegistry.Config.int_env("ANALYTICS_RECEIVE_TIMEOUT_MS", 2_000),
    analytics_pool_timeout_ms: TuistRegistry.Config.int_env("ANALYTICS_POOL_TIMEOUT_MS", 1_000),
    registry_github_token: env.("REGISTRY_GITHUB_TOKEN"),
    registry_sync_enabled: TuistRegistry.Config.bool_env("REGISTRY_SYNC_ENABLED", true),
    registry_sync_allowlist: TuistRegistry.Config.list_env("REGISTRY_SYNC_ALLOWLIST")
