defmodule TuistRegistry.Disk do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> TuistRegistry.Disk.artifact_path("registry/swift/apple/parser/1.0.0/source_archive.zip")
  ...
  ## Examples
      ...
      iex> TuistRegistry.Disk.shards_for_id("ABCD1234")
      {"AB", "CD"}
  """
  ...
  """
  def storage_dir do
    Application.get_env(:tuist_registry, :storage_dir)
  end
  ...
  ## Examples
      ...
      iex> TuistRegistry.Disk.local_base_path()
      "/internal/local/"
  """
  ...
  ## Examples
      ...
      iex> TuistRegistry.Disk.ensure_directory("/path/to/file.txt")
      :ok
  """
  ...
  ## Examples
      ...
      iex> TuistRegistry.Disk.move_file("/tmp/upload-123", "/storage/artifact")
      :ok
  """
  ...
  ## Examples
      ...
      iex> TuistRegistry.Disk.format_bytes(512)
      "512 B"

      iex> TuistRegistry.Disk.format_bytes(1_536)
      "1.5 KB"
  """
