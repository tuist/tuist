defmodule TuistRegistry.Swift.SyncWorker do
  @moduledoc """
  ...
  alias TuistRegistry.Swift.Lock
  alias TuistRegistry.Swift.Metadata
  alias TuistRegistry.Swift.ReleaseWorker
  alias TuistRegistry.Swift.SwiftPackageIndex
  alias TuistRegistry.Swift.SyncCursor

  require Logger

  @github_opts [finch: TuistRegistry.Finch, retry: false]
  ...
  defp registry_sync_allowlist do
    Application.get_env(:tuist_registry, :registry_sync_allowlist)
  end

  defp registry_sync_limit do
    Application.get_env(:tuist_registry, :registry_sync_limit)
  end
end
