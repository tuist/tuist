defmodule TuistRegistry.Swift.KeyNormalizer do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> TuistRegistry.Swift.KeyNormalizer.normalize_scope("Apple")
      "apple"

      iex> TuistRegistry.Swift.KeyNormalizer.normalize_scope("SWIFT")
      "swift"
  """
  ...
  ## Examples
      ...
      iex> TuistRegistry.Swift.KeyNormalizer.normalize_name("swift.argument.parser")
      "swift_argument_parser"

      iex> TuistRegistry.Swift.KeyNormalizer.normalize_name("SwiftNIO")
      "swiftnio"
  """
  ...
  ## Examples
      ...
      iex> TuistRegistry.Swift.KeyNormalizer.normalize_scope_name("Apple", "swift.argument.parser")
  ...
  ## Examples
      ...
      iex> TuistRegistry.Swift.KeyNormalizer.normalize_version("v1.2.3")
      "1.2.3"

      iex> TuistRegistry.Swift.KeyNormalizer.normalize_version("1")
      "1.0.0"

      iex> TuistRegistry.Swift.KeyNormalizer.normalize_version("1.2")
      "1.2.0"

      iex> TuistRegistry.Swift.KeyNormalizer.normalize_version("1.0.0-alpha.1")
      "1.0.0-alpha.1"

      iex> TuistRegistry.Swift.KeyNormalizer.normalize_version("v2.0.0-beta.2")
      "2.0.0-beta.2"

      iex> TuistRegistry.Swift.KeyNormalizer.normalize_version("0.20.0-prerelease-5")
      "0.20.0-prerelease-5"
  """
  ...
  ## Examples
      ...
      iex> TuistRegistry.Swift.KeyNormalizer.package_object_key(%{scope: "Apple", name: "Parser"}, version: "v1.2", path: "source_archive.zip")
      "registry/swift/apple/parser/1.2.0/source_archive.zip"

      iex> TuistRegistry.Swift.KeyNormalizer.package_object_key(%{scope: "swift", name: "nio"}, version: "2.0.0", path: "Package.swift")
      "registry/swift/swift/nio/2.0.0/Package.swift"

      iex> TuistRegistry.Swift.KeyNormalizer.package_object_key(%{scope: "Apple", name: "Parser"}, [])
