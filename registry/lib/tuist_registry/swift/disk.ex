defmodule TuistRegistry.Swift.Disk do
  @moduledoc """
  ...
  alias TuistRegistry.Disk
  alias TuistRegistry.Swift.KeyNormalizer
  ...
  ## Examples
      ...
      iex> TuistRegistry.Swift.Disk.key("Apple", "Parser", "v1.2", "source_archive.zip")
  ...
  ## Examples
      ...
      iex> TuistRegistry.Swift.Disk.exists?("apple", "parser", "1.0.0", "source_archive.zip")
      true
  """
  ...
  ## Examples
     ...
     iex> TuistRegistry.Swift.Disk.put("apple", "parser", "1.0.0", "source_archive.zip", <<1, 2, 3>>)
     :ok

      iex> TuistRegistry.Swift.Disk.put("apple", "parser", "1.0.0", "source_archive.zip", {:file, "/tmp/upload"})
      :ok
  """
  ...
  ## Examples
      ...
      iex> TuistRegistry.Swift.Disk.stat("apple", "parser", "1.0.0", "source_archive.zip")
  ...
  ## Examples
      ...
      iex> TuistRegistry.Swift.Disk.local_accel_path("apple", "parser", "1.0.0", "source_archive.zip")
