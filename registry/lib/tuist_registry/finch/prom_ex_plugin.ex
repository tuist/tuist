defmodule TuistRegistry.Finch.PromExPlugin do
  @moduledoc """
  ...
  alias TuistRegistry.Finch.Pools
  ...
  def polling_metrics(opts) do
    ...
    Polling.build(
      :tuist_registry_finch_pool_polling_metrics,
      poll_rate,
      {__MODULE__, :execute_pool_metrics, []},
      [
        last_value(
          [:tuist_registry, :prom_ex, :finch, :pool, :available_connections],
          event_name: [:tuist_registry, :prom_ex, :finch, :pool],
        ...
        last_value(
          [:tuist_registry, :prom_ex, :finch, :pool, :in_use_connections],
          event_name: [:tuist_registry, :prom_ex, :finch, :pool],
        ...
        last_value(
          [:tuist_registry, :prom_ex, :finch, :pool, :size],
          event_name: [:tuist_registry, :prom_ex, :finch, :pool],
  ...
  defp emit_pool_metrics(url) do
    case Finch.get_pool_status(TuistRegistry.Finch, url) do
      {:ok, []} ->
        :ok
      ...
      {:ok, pools} ->
        ...
        :telemetry.execute(
          [:tuist_registry, :prom_ex, :finch, :pool],
          totals,
          %{url: url}
        )
