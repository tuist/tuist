defmodule TuistRegistry.S3TransferWorker do
  @moduledoc """
  ...
  alias TuistRegistry.S3Transfers
  ...
  defp handle_result(:download, {:ok, {transfer, {:ok, :hit}}}) do
    ...
    :telemetry.execute([:tuist_registry, :registry, :download, :s3_hit], %{size: size}, %{
  ...
  defp handle_result(:download, {:ok, {transfer, {:ok, :miss}}}) do
    :telemetry.execute([:tuist_registry, :registry, :download, :s3_miss], %{}, %{
      account_handle: transfer.account_handle,
      project_handle: transfer.project_handle
    })
