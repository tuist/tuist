...
export const SCENARIO_PLANS: ScenarioPlan[] = [
  ...
  { key: 'module_read_5mb', exec: 'moduleRead5mb', rate: 60, duration: 10, expectedLatencyMs: 150, minIterations: 540 },
  { key: 'module_read_10mb', exec: 'moduleRead10mb', rate: 14, duration: 15, expectedLatencyMs: 1200, minIterations: 190 },
  { key: 'module_read_25mb', exec: 'moduleRead25mb', rate: 10, duration: 20, expectedLatencyMs: 3000, minIterations: 180 },

  { key: 'module_write_5mb', exec: 'moduleWrite5mb', rate: 6, duration: 30, expectedLatencyMs: 2500, minIterations: 160 },
  { key: 'module_write_10mb', exec: 'moduleWrite10mb', rate: 3, duration: 45, expectedLatencyMs: 5000, minIterations: 120 },
  { key: 'module_write_25mb', exec: 'moduleWrite25mb', rate: 1, duration: 60, expectedLatencyMs: 12000, minIterations: 55 },

  { key: 'gradle_read_5mb', exec: 'gradleRead5mb', rate: 60, duration: 10, expectedLatencyMs: 150, minIterations: 540 },
  { key: 'gradle_read_10mb', exec: 'gradleRead10mb', rate: 14, duration: 15, expectedLatencyMs: 1200, minIterations: 190 },
  { key: 'gradle_read_25mb', exec: 'gradleRead25mb', rate: 10, duration: 20, expectedLatencyMs: 3000, minIterations: 180 },

  { key: 'gradle_write_5mb', exec: 'gradleWrite5mb', rate: 6, duration: 25, expectedLatencyMs: 1500, minIterations: 135 },
  { key: 'gradle_write_10mb', exec: 'gradleWrite10mb', rate: 3, duration: 35, expectedLatencyMs: 3000, minIterations: 95 },
  { key: 'gradle_write_25mb', exec: 'gradleWrite25mb', rate: 1, duration: 50, expectedLatencyMs: 7000, minIterations: 45 },
];
