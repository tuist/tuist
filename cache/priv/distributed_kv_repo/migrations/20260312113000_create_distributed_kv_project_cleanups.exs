defmodule Cache.DistributedKV.Repo.Migrations.CreateProjectCleanups do
  use Ecto.Migration

  def change do
    create table(:project_cleanups, primary_key: false) do
    ...
    create index(:project_cleanups, [:lease_expires_at])
  end
end
