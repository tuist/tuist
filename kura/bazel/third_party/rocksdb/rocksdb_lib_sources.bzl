# Generated from librocksdb-sys 0.17.3+10.4.2 rocksdb_lib_sources.txt (LIB_SOURCES).
# The crate's own build.rs compiles exactly these plus the pre-generated build_version.cc.
ROCKSDB_LIB_SOURCES = [
