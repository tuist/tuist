...
- The CLI HTTP cache client is generated from `openapi/cache.yml` with `mise run generate-cli-client`. Keep the specification synchronized with the HTTP handlers.
