...
- Resource budgets: file-descriptor pool, memory soft/hard limits, tmp staging, manifest cache, snapshot cache, and RocksDB write buffer pool, all with defaults derived from Kura's bounded runtime model.
