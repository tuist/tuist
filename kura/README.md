...
bounded identifier, adds it to request spans and structured completion events, and forwards it to
extension control-plane requests. Successful completion events are disabled by default and can be
