...
`staging_probe.py` validates readiness and authenticated HTTP/REAPI blob round trips
...
`reapi-smoke.proto` is the minimal wire-compatible CAS schema used by grpcurl.
