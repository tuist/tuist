...
- The registry API is served at the ingress root, for example `https://swift-registry.tuist.dev`.
...
- Prefer a dedicated 1Password item named `SWIFT_REGISTRY` with fields matching `runtimeSecrets.externalSecret.fields`.
