...
func TestSASCReconciler_MarksControlPlaneInitializedOnParentCluster(t *testing.T) {
	...
	cluster := &clusterv1.Cluster{
		...
		Spec: clusterv1.ClusterSpec{
			InfrastructureRef: &corev1.ObjectReference{
				...
				Kind:       "ScalewayAppleSiliconCluster",
				Name:       "tuist-tuist-capi",
				Namespace:  "tuist-staging",
			},
		},
	...
	r := &ScalewayAppleSiliconClusterReconciler{
		Client: cl,
		Scheme: scheme,
	}
	...
	got := &infrav1.ScalewayAppleSiliconCluster{}
...
// InfrastructureRef points at a ScalewayAppleSiliconCluster to a
