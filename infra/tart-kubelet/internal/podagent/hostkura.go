...
// safePathElement rejects values that are not safe to interpolate into a
// filesystem path (traversal, separators). Account IDs come from a
// server-stamped label, but this guards against a compromised/renamed label.
