...
## What's Changed in xcresult-processor-image@0.12.3<!-- RELEASE NOTES START -->
...
**Full Changelog**: https://github.com/tuist/tuist/compare/xcresult-processor-image@0.12.2...xcresult-processor-image@0.12.3
...
* disable Kura Cloudflare load balancing ([#10990](https://github.com/tuist/tuist/pull/10990))
...
* add Cloudflare global routing ([#10783](https://github.com/tuist/tuist/pull/10783))
...
* restore translation guide search sync ([#10897](https://github.com/tuist/tuist/pull/10897))
...
**Full Changelog**: https://github.com/tuist/tuist/compare/xcresult-processor-image@0.6.1...xcresult-processor-image@0.8.0
...
**Full Changelog**: https://github.com/tuist/tuist/compare/xcresult-processor-image@0.4.0...xcresult-processor-image@0.6.1

## What's Changed in xcresult-processor-image@0.4.0<!-- RELEASE NOTES START -->
...
**Full Changelog**: https://github.com/tuist/tuist/compare/xcresult-processor-image@0.3.0...xcresult-processor-image@0.4.0
...
* add Homebrew instructions for build insights post-action ([#10254](https://github.com/tuist/tuist/pull/10254))
...
* add CLI command reference documentation ([#10037](https://github.com/tuist/tuist/pull/10037))
...
* add comparison API endpoints, CLI commands, and agent skills ([#9773](https://github.com/tuist/tuist/pull/9773))
...
* add credo lint for `@spec` usage ([#9212](https://github.com/tuist/tuist/pull/9212))
...
* Markdown translation update from Weblate ([#8937](https://github.com/tuist/tuist/pull/8937))
...
* add a ci account token scope group to replace project tokens ([#8882](https://github.com/tuist/tuist/pull/8882))
...
* Document and write a blog post about target metadata tags ([#8531](https://github.com/tuist/tuist/pull/8531))
...
* authenticate projects ([#8474](https://github.com/tuist/tuist/pull/8474))
* add worker ([#8451](https://github.com/tuist/tuist/pull/8451))
...
* submit step reports asynchronously ([#8087](https://github.com/tuist/tuist/pull/8087))
...
* run app for QA ([#7896](https://github.com/tuist/tuist/pull/7896))
* add support for Apple App Site Association ([#7887](https://github.com/tuist/tuist/pull/7887))
* support page ([#7839](https://github.com/tuist/tuist/pull/7839))
* add button to delete account ([#7818](https://github.com/tuist/tuist/pull/7818))
* use deviceURL instead of itms scheme to install previews ([#7820](https://github.com/tuist/tuist/pull/7820))
* implement preview detail ([#7792](https://github.com/tuist/tuist/pull/7792))
### 🐛 Bug Fixes
...
* split sops secrets into per-environment files ([#10142](https://github.com/tuist/tuist/pull/10142))
...
* revert toggle fixes ([#9879](https://github.com/tuist/tuist/pull/9879))
* fix Toggle reset in Chrome when inside LiveView forms ([#9875](https://github.com/tuist/tuist/pull/9875))
...
* enable Gradle build cache and fix cache hit rate ([#9587](https://github.com/tuist/tuist/pull/9587))
...
* previews docs link ([#8857](https://github.com/tuist/tuist/pull/8857))
...
* handle token_expired error ([#7869](https://github.com/tuist/tuist/pull/7869))
### 🚜 Refactor
...
* implement streaming read parallelism ([#7928](https://github.com/tuist/tuist/pull/7928))
* create separate Ingest repository ([#7927](https://github.com/tuist/tuist/pull/7927))
* reorganize marketing artwork components and update layout ([#7836](https://github.com/tuist/tuist/pull/7836))
### 📚 Documentation

* update marketing hero copy ([#9933](https://github.com/tuist/tuist/pull/9933))
* self-hosted cache for self-hosted server ([#9200](https://github.com/tuist/tuist/pull/9200))
