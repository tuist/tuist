...
// bind over an existing file), the pid file the jailer creates with O_EXCL,
// and the whole /dev tree, because the jailer mknods kvm, net/tun, urandom
// and userfaultfd itself and fails on EEXIST.
