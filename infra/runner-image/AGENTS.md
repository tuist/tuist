...
- `setup-assistant.mobileconfig` + runner `SetupAssistant`
  defaults — skip first-run panes such as Apple Account, Privacy,
  Siri, Screen Time, and automatic software update so VNC opens on
  the runner desktop instead of Setup Assistant.
