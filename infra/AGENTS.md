...
- `mgmt/etcd-snapshot.yaml`, `mgmt/tailscale.yaml`, `mgmt/kura-capacity-retry.yaml` — mgmt-cluster workloads (hourly etcd snapshot to Tigris, tailnet-only operator access, and Kura regional Hetzner-capacity retries).
