...
### `vm-image-builder.md` — bare-metal Mac mini onboarding runbook
End-to-end steps for standing up a new `vm-image-builder` Mac mini that builds the runner and xcresult-processor Tart images. The fleet is intentionally bare-metal and outside CAPI; see the doc for why.
