...
### `clickhouse/` — ClickHouse access bootstrap
Operator-run provisioning for restricted ClickHouse users that cannot be expressed through the managed ClickHouse service configuration. See [`clickhouse/README.md`](clickhouse/README.md).
