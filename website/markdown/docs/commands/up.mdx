...
excerpt: 'Learn how developers in your team can use the up command to set up their environments with the tools that are necessary for the projects to run'
---
...
```swift
.carthage(platforms: [.macOS], useXCFrameworks: true)
```
