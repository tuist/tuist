...
excerpt: This documents describes a framework for proposing, executing, and rolling out projects.
---
...
The outcome of this phase must be a topic on the [projects](https://community.tuist.io/c/projects/14) category of the community forum. The topic should follow the default template. The Tuist core team, maintainers, and contributors will dump any concerns or thoughts about the proposed solution. The goal of the discussion is to seek alignment and introduce any necessary modifications to achieve that.
