...
## Example app
If you are eager to see an example of an app with a µFeatures architecture you can check out the [example app](https://github.com/tuist/microfeatures-example). It's structured following the principles described in the following sections.
