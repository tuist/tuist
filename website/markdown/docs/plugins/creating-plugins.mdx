...
Project description helpers can be used to extend Tuists functionality and Tuist automatically grabs the sources for
these, compiles it, and allows it to be imported during project generation.
