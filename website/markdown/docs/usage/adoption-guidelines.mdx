...
Tuist will make sure that projects are consistently defined and that they remain simple.
...
You can do that by implementing a script that reads the build settings using [XcodeProj](https://github.com/tuist/xcodeproj),
