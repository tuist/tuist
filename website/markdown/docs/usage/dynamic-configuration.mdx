...
excerpt: Learn how to leverage environment variables that can be read from the manifest files.
---
...
If you want to pass multiple environment variables just separate them with space. For example: 
