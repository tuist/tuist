---
layout: post
title: '#4 Søren Gregersen - Thanks to Tuist anyone in the team can create and maintain Xcode projects easily'
categories:
  [
    Tuist,
    SorenSHG,
...
excerpt: 'In this interview we talk with Søren Gregersen, a digital studio based in Denmark. Søren shared with us how they use Tuist and the project description helpers for one of their main projects, a white label app for shopping malls in Europe.'
