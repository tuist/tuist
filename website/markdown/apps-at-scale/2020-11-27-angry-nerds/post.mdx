...
header_image: 'https://unsplash.com/photos/zuZRXeCSJ00/download?force=true&w=1920'
interviewee_name: 'Angry Nerds'
interviewee_twitter_handle: 'angrynerds_soft'
interviewee_avatar: https://avatars3.githubusercontent.com/u/5724230?s=460&u=7b97b7538d0391f1c89945a2ed1b6b7aa9d2d236&v=4
...
[Tuist up](/docs/commands/up/) command - we really like the fact that we can provide the project’s dependencies to other developers beforehand, so they don't need to waste time on the tools setup and just do it all by executing one command. We also appreciate [Tuist graph](/docs/commands/graph/) command - because we can quickly show other developers the high level view of communication between all app’s modules.
