...
For that reason,
we updated our documentation to include a [manifesto](/docs/contribution/manifesto/) that contains a set of principles that are foundational to the design and development of Tuist.
...
As soon as users reported, that caused some issues because GitHub's API returned limit errors.
...
- Integrate the management of certificates into.
