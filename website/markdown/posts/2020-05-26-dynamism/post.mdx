...
For that reason,
if I was Apple, I would keep Xcode projects as static as possible. With Xcode 11,
...
- [Defining dependencies](/docs/usage/dependencies/) explicitly with a simple and unified DSL.
...
- Generating a [visual dependency tree](/docs/commands/graph/) to have an overview of the project.
...
Here are some concrete examples to illustrate that the above:
...
you can check out our [Getting Started](/docs/usage/getting-started/) documentation.
