...
While for automating the process of generating provisioning profiles you'll have to wait as
that is still work in progress, in this release we bring you easy integration of already
created provisioning profiles and certificates.
...
You can find more info in the [documentation](https://tuist.io/docs/signing/signing/)

You can also check out an introduction [video](https://youtu.be/WGKp1EHcpME) where we
