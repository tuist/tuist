...
Despite our plan to release new versions [every Friday](/docs/contribution/release/),
...
Moreover, we paused the work on the cache to refactor one of our key pieces of the codebase, the [graph](https://github.com/tuist/tuist/blob/master/Sources/TuistCore/Graph/Graph.swift).
Since its creation,
