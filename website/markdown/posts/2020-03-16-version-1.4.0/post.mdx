...
You can read more about how it works on the [commands](http://127.0.0.1:8000/docs/usage/commands/) documentation page.
...
we decided that it makes more sense to require it to be in a directory where other global files are *(e.g. project description helpers)*.
