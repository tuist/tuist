...
export declare function useDisposables(): {
    addEventListener<TEventName extends keyof WindowEventMap>(element: Window | HTMLElement | Document, name: TEventName, listener: (event: WindowEventMap[TEventName]) => any, options?: boolean | AddEventListenerOptions | undefined): () => void;
