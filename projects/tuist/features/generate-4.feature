...
Scenario: The project is a visionOS application with remote Swift package (visionos_app_with_remote_swift_package)
    Given that tuist is available
    And I have a working directory
    Then I copy the fixture visionos_app_with_remote_swift_package into the working directory
    Then tuist generates the project
