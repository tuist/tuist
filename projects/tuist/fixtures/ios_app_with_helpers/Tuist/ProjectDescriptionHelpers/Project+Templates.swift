...
public extension Project {
    static func app(name: String, platform: Platform, dependencies: [TargetDependency] = []) -> Project {
    ...
    static func framework(name: String, platform: Platform, dependencies: [TargetDependency] = []) -> Project {
