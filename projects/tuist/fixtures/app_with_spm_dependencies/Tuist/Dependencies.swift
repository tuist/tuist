...
let packages: [Package] = [
    ...
    .package(url: "https://github.com/firebase/firebase-ios-sdk", .upToNextMajor(from: "10.12.0")),
    ...
    .package(url: "https://github.com/stripe/stripe-ios", .upToNextMajor(from: "23.11.1")),
