...
<Message
  info
  title="Example"
  description="[`generate.features`](https://github.com/tuist/tuist/blob/main/projects/tuist/features/generate-1.feature) has several scenarios that run `tuist generate` on a fixture, verify Xcode projects and workspaces are generated and finally verify the generated project build and test successfully."
/>
