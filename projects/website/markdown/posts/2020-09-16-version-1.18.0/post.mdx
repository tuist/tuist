...
You can read more about the feature [here](/docs/commands/doc/).
...
You can read more about the functionality and how to provide your SwiftLint configuration on [this page](/docs/commands/linting/).
