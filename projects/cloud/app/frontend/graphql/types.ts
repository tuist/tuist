...
export type Query = {
  ...
  commandEvents: Array<CommandEvent>;
...
export type CommandEventDetailFragment = { __typename?: 'CommandEvent', name: string, subcommand?: string | null, commandArguments: string, duration: number, clientId: string, tuistVersion: string, swiftVersion: string, macosVersion: string };
...
export type CommandEventsQuery = { __typename?: 'Query', commandEvents: Array<{ __typename?: 'CommandEvent', name: string, subcommand?: string | null, commandArguments: string, duration: number, clientId: string, tuistVersion: string, swiftVersion: string, macosVersion: string }> };
...
export const CommandEventsDocument = gql`
    query CommandEvents($projectId: ID!) {
  commandEvents(projectId: $projectId) {
    ...CommandEventDetail
  }
}
