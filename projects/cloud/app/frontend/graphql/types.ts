...
export type CommandEventsQuery = { __typename?: 'Query', commandEvents: Array<{ __typename?: 'CommandEvent', id: string, name: string, subcommand?: string | null, commandArguments: string, duration: number, clientId: string, tuistVersion: string, swiftVersion: string, macosVersion: string, createdAt: string }> };
