...
One the cache is warmed, you can use the [generate](/commands/generate/) command to generate a project replacing direct and transitive dependencies with artifacts from the cache.
