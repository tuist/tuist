...
| `--destination`       | `N/A` | Output type of xcframeworks when `--xcframeworks` is passed (device/simulator/all)                                             | Both device and simulator                       | No       |
...
| `--destination`       | `N/A` | Output type of xcframeworks when `--xcframeworks` is passed (device/simulator/all)                                | all                   | No       |
