...
- `js/` - JavaScript hooks and behaviors. `ScrollIndicator.js` provides shared thumb sizing and dragging for table and chart scrollbars, styled by `css/scroll_indicator.css`.
