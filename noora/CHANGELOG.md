...
## [web-0.76.0] - 2026-03-10
### Details
#### Features
- Add in_progress status to status_badge by @fortmarek in [#989](https://github.com/tuist/Noora/pull/989)

## [web-0.75.0] - 2026-03-10
### Details
#### Features
- Add list-tree icon by @pepicrft in [#993](https://github.com/tuist/Noora/pull/993)

## [web-0.74.0] - 2026-03-10
### Details
#### Features
- Add :not_contains operator to :list filter type by @fortmarek in [#992](https://github.com/tuist/Noora/pull/992)
...
### Details
#### Features
- Add menu-3 icon by @pepicrft in [#987](https://github.com/tuist/Noora/pull/987)

## [web-0.71.0] - 2026-03-05
### Details
#### Features
- Add copy-check icon by @pepicrft in [#978](https://github.com/tuist/Noora/pull/978)
...
### Details
#### Features
- Add button dropdown component by @pepicrft in [#967](https://github.com/tuist/Noora/pull/967)

## [web-0.68.0] - 2026-03-02
### Details
#### Features
- Add icon neutral tokens by @fortmarek in [#964](https://github.com/tuist/Noora/pull/964)

## [web-0.67.0] - 2026-03-02
### Details
#### Features
- Photo icon by @fortmarek in [#963](https://github.com/tuist/Noora/pull/963)
...
### Details
#### Bug Fixes
- Remove max-height on content by @cschmatzler in [#949](https://github.com/tuist/Noora/pull/949)

## [web-0.64.1] - 2026-02-20
### Details
#### Bug Fixes
- Date picker shadow by @asmitbm in [#939](https://github.com/tuist/Noora/pull/939)

## [web-0.64.0] - 2026-02-17
### Details
#### Features
- Add brand-android icon by @fortmarek in [#929](https://github.com/tuist/Noora/pull/929)

## [web-0.63.2] - 2026-02-11
### Details
#### Bug Fixes
- Coerce filter values to match defined option types by @cschmatzler in [#919](https://github.com/tuist/Noora/pull/919)
...
### Details
#### Features
- Add badge support to breadcrumb components by @fortmarek in [#915](https://github.com/tuist/Noora/pull/915)
...
### Details
#### Features
- Add chart-bar-popular icon by @asmitbm in [#884](https://github.com/tuist/Noora/pull/884)

## [web-0.59.0] - 2026-01-23
### Details
#### Features
- Add icon-primary-background color by @fortmarek in [#869](https://github.com/tuist/Noora/pull/869)
...
### Details
#### Bug Fixes
- Handle names with consecutive delimiters by @fortmarek in [#849](https://github.com/tuist/Noora/pull/849)
...
### Details
#### Features
- Add alert-triangle-off by @fortmarek in [#839](https://github.com/tuist/Noora/pull/839)
...
### Details
#### Bug Fixes
- Add missing column gap in table by @fortmarek in [#832](https://github.com/tuist/Noora/pull/832)

## [web-0.53.0] - 2026-01-13
### Details
#### Features
- Add git-commit icon by @fortmarek in [#827](https://github.com/tuist/Noora/pull/827)
...
### Details
#### Features
- Add toggle component by @fortmarek in [#813](https://github.com/tuist/Noora/pull/813)
...
### Details
#### Features
- Add `git_merge` icon by @pepicrft in [#739](https://github.com/tuist/Noora/pull/739)

## [web-0.45.0] - 2025-11-28
### Details
#### Features
- Add server icon by @fortmarek in [#730](https://github.com/tuist/Noora/pull/730)

## [web-0.44.3] - 2025-11-28
### Details
#### Bug Fixes
- Small button styling by @fortmarek in [#729](https://github.com/tuist/Noora/pull/729)

## [web-0.44.2] - 2025-11-27
### Details
#### Bug Fixes
- Change unit from s to ms for sub-second values by @fortmarek in [#725](https://github.com/tuist/Noora/pull/725)
...
### Details
#### Features
- Add event listener to programmatically open a modal by @fortmarek in [#692](https://github.com/tuist/Noora/pull/692)

## [web-0.43.0] - 2025-11-17
### Details
#### Features
- Add rest attr to modal by @fortmarek in [#691](https://github.com/tuist/Noora/pull/691)
...
### Details
#### Features
- Add :rest attr to the dropdown by @fortmarek in [#682](https://github.com/tuist/Noora/pull/682)

## [web-0.40.6] - 2025-11-13
### Details
#### Bug Fixes
- Ensure text in a column is cut with ellipsis when it would outgrow the column width by @fortmarek in [#681](https://github.com/tuist/Noora/pull/681)

## [web-0.40.5] - 2025-11-13
### Details
#### Bug Fixes
- Ensure expand icon doesn't shrink by @fortmarek in [#680](https://github.com/tuist/Noora/pull/680)

## [web-0.40.4] - 2025-11-11
### Details
#### Bug Fixes
- Boolean condition by @fortmarek in [#673](https://github.com/tuist/Noora/pull/673)
...
### Details
#### Bug Fixes
- Removed padding when row not expandable by @fortmarek in [#671](https://github.com/tuist/Noora/pull/671)

## [web-0.40.1] - 2025-11-10
### Details
#### Bug Fixes
- Label not shown when existing slots for links in dropdown by @fortmarek in [#670](https://github.com/tuist/Noora/pull/670)

## [web-0.40.0] - 2025-11-10
### Details
#### Features
- Table expandable rows by @fortmarek in [#667](https://github.com/tuist/Noora/pull/667)

## [web-0.39.1] - 2025-11-10
### Details
#### Bug Fixes
- Label not shown when existing slots by @fortmarek in [#669](https://github.com/tuist/Noora/pull/669)
...
[web-0.63.2]: https://github.com/tuist/Noora/compare/web-0.63.1..web-0.63.2
...
[web-0.44.2]: https://github.com/tuist/Noora/compare/web-0.44.1..web-0.44.2
...
[web-0.40.4]: https://github.com/tuist/Noora/compare/web-0.40.3..web-0.40.4
...
[web-0.39.1]: https://github.com/tuist/Noora/compare/web-0.39.0..web-0.39.1
