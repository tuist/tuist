...
We believe this is a crucial feature for any team that wants to ship reliable software. If you want to try it, start using Tuist Cloud (soon to be renamed to Tuist) and run `tuist test` in your project. We welcome your feedback and look forward to hearing from you.
